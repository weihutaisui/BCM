...
#elif defined(CONFIG_CPU_LITTLE_ENDIAN) || defined(CONFIG_ARM)
#define BLOG_IPV4_ADDR(ip)      ((uint8_t*)&ip)[3], ((uint8_t*)&ip)[2],     \
...
#elif defined(CONFIG_CPU_LITTLE_ENDIAN) || defined(CONFIG_ARM)
#define BLOG_IPV6_ADDR(ip)      \
    ntohs(((uint16_t*)&ip)[7]), ntohs(((uint16_t*)&ip)[6]),   \
    ntohs(((uint16_t*)&ip)[5]), ntohs(((uint16_t*)&ip)[4]),   \
    ntohs(((uint16_t*)&ip)[3]), ntohs(((uint16_t*)&ip)[2]),   \
    ntohs(((uint16_t*)&ip)[1]), ntohs(((uint16_t*)&ip)[0])
#endif
