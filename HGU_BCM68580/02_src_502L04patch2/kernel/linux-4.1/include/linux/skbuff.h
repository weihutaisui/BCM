...
#define SKB_RECYCLE_FPM_DATA (1 << 3)	/* Data buffer was allocated from Runner FPM pool */
...
#define PKT_TYPE_OFFSET()	offsetof(struct sk_buff, __pkt_type_offset)
	...
	/* dma_index is needed by Bulk Tx for HND router platforms with wl in NIC mode */
	__u16			dma_index;
	__u16			pktc_flags;
