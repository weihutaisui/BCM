...
#define MAX_DHCP_OPTION_LEN  256
...
/* Note: the definition should be consistent with the one in files: 
** userspace/private/libs/cms_core/linux/rut_dhcp.h.
...
#define VENDOR_OPTION_SUBCODE_OFFSET  2
