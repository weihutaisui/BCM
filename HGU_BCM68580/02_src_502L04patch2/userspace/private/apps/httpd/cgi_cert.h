...
#ifndef __CGI_CERT_H__
#define __CGI_CERT_H__
...
void cgiCertAdd(char *path, FILE *fs, int type);
void cgiCertRemove(char *path, FILE *fs, int type);
...
CertificateCfgObject *cgiCertAlloc(void);
void cgiCertFree(CertificateCfgObject *certCfg);
