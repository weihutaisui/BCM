...
#define LINMOSD_VERSION_MAJOR   1
#define LINMOSD_VERSION_MINOR   0
#define LINMOSD_VERSION_PATCH   0

#define LINMOSD_LOCK_TIMEOUT (5*1000)

extern UBOOL8 saveConfigNeeded;
extern UBOOL8 keepRunning;
...
void startExecEnv(void);
void stopExecEnv(void);
