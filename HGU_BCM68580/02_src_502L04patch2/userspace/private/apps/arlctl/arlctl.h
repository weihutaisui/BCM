 ...
 *******************************************************************************
 * File Name  : arlctl.h
 * Description: Command line parsing for the Broadcom ARL Control Utility
 *******************************************************************************
 */
...
/* Return codes. */
#define ARL_GENERAL_ERROR                 100
#define ARL_NOT_FOUND                     101
#define ARL_ALLOC_ERROR                   102
#define ARL_INVALID_COMMAND               103

#define ARL_INVALID_OPTION                104
#define ARL_INVALID_PARAMETER             105
#define ARL_INVALID_NUMBER_OF_OPTIONS     106
#define ARL_INVALID_NUMBER_OF_PARAMETERS  107
