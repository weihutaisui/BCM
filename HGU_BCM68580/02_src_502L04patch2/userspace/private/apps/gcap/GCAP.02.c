...
{
    printf("Usage: GCAP.02 <OF> [-p <00/01/10>][-s <00/01/10>][-M] [-r] [-h]\n\
Set Golden Node to operate at a single frequency or network search.\n\
...
GCAP_GEN int GCAP_02_main(int argc, char **argv)
{
