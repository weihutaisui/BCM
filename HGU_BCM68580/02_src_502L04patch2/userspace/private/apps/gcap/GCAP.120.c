...
{
    printf("Usage: GCAP.120 [-t timeslot] [-h]\n\
Request a Loopback Probe LMO from the NC.\n\
\n\
Options:\n\
  -h     Display this help and exit\n\
  -t     timeslot, specify the timeslot of the loopback probe\n");
}


GCAP_GEN int GCAP_120_main(int argc, char **argv)
{
    int ret;
    ...
    probe_req.probe_type = MOCA_PROBE_REQUEST_TYPE_LOOPBACK;
