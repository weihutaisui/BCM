...
//  $Id$
//
//  Filename:       BatteryCommandTable.h
//  Author:         Kevin O'Neal
...
#ifndef BATTERYCOMMANDTABLE_H
#define BATTERYCOMMANDTABLE_H
...
class BcmBatteryCommandTable : public BcmCommandTable
{
public:
    ...
    // Returns:  N/A
    //
    virtual ~BcmBatteryCommandTable();
...
private:
    ...
    // Returns:  N/A
    //
    BcmBatteryCommandTable(const BcmBatteryCommandTable &otherInstance);
    ...
    //
    BcmBatteryCommandTable & operator = (const BcmBatteryCommandTable &otherInstance);

	static BcmBatteryCommandTable *Singleton();
	void AddLifeTestCommands();
	friend class BcmBatteryThread;

};

class BcmBatteryATECommandTable : public BcmCommandTable
{
public:
    ...
    // Returns:  N/A
    //
    virtual ~BcmBatteryATECommandTable();
...
private:
    ...
    // Returns:  N/A
    //
    BcmBatteryATECommandTable(const BcmBatteryATECommandTable &otherInstance);
    ...
    //      A reference to "this" so that operator = can be chained.
    //
    BcmBatteryATECommandTable & operator = (const BcmBatteryATECommandTable &otherInstance);
