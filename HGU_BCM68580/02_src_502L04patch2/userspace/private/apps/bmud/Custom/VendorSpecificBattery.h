 ...
 *
 ************************************************************************/
#ifndef VENDORSPECIFICBATTERY_H
#define VENDORSPECIFICBATTERY_H
...
extern const TBatDischargeTable defaultVendorSpecificDischargeTable;
#define VENDOR_SPECIFIC_DISCHARGE_TABLE &defaultVendorSpecificDischargeTable
