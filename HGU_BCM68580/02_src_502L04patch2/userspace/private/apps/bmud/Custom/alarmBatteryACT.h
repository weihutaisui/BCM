...
* :> 
*/
#ifndef ALARMBATTERYACT_H
#define ALARMBATTERYACT_H

#include "CompletionHandlerACT.h"

class alarmBatteryACT : public BcmCompletionHandlerACT
{
public:
...
private:
	// Copy Constructor.
	//
	alarmBatteryACT( const alarmBatteryACT& rhs );

	// Assignment operator.
	//
	alarmBatteryACT& operator=( const alarmBatteryACT& rhs );

	void SetDyingGaspInterrupt(int enable);
};
