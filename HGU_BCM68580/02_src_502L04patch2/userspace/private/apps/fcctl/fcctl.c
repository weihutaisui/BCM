 ...
 *              implemented in the fcCtl_6368.c and fcCtl_6816.c
 ***************************************************************************/
...
#endif
{
    ...
    while ( argc && nExitCode == 0 )
    {
        ...
        {
            nExitCode = FCCTL_INVALID_COMMAND;
...
{
    int nRet = FCACHE_SUCCESS, nNumOptInfo = 0, nArgType = 0;
    ...
    *pnArgNext = 0;
    ...
    do
    {
        ...
        case ARG_TYPE_OPTION:
            ...
            {
                nRet = FCCTL_INVALID_NUMBER_OF_OPTIONS;
    ...
    } while ( (nRet == FCACHE_SUCCESS) && (nArgType!=ARG_TYPE_COMMAND) );

    if ( nRet == FCACHE_SUCCESS )
