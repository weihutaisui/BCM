...
*    Description:
*
*      OMCID timer functions for polling PM counters.
*
*****************************************************************************/

#ifndef __OMCID_PM_TIMER_H__
#define __OMCID_PM_TIMER_H__
