...
*    Description:
*
*      OMCID custom STL/RCL handlers. Mostly for table attributes.
*
*****************************************************************************/
...
typedef CmsRet (*OMCI_CUSTOM_FNC_SET)(void *mdmObj, InstanceIdStack
  *pIidStack, UINT16 attrMask);
typedef CmsRet (*OMCI_CUSTOM_FNC_GET)(void **mdmObj, UINT16 *objSize,
...
CmsRet setBroadcastKeyTableData(void *mdmObj, InstanceIdStack *pIidStack,
  UINT16 attrMask);
CmsRet setMulticastGemInterworkingTp(void *mdmObj, InstanceIdStack *pIidStack,
  UINT16 attrMask);
CmsRet setExtendedVlanTaggingOperationConfigurationData(void *mdmObj,
  InstanceIdStack *pIidStack, UINT16 attrMask);
CmsRet setMacBridgePortFilterTableData(void *mdmObj, InstanceIdStack *pIidStack,
  UINT16 attrMask);
CmsRet setMulticastOperationsProfile(void *mdmObj, InstanceIdStack *pIidStack,
  UINT16 attrMask);
...
CmsRet getMulticastSubscriberMonitor(void **obj, UINT16 *objSize,
  InstanceIdStack *pIidStack, UINT16 attrMask);
CmsRet getOmciMe(void **obj, UINT16 *objSize, InstanceIdStack *pIidStack,
  UINT16 attrMask);
