 ...
 *******************************************************************************
 * File Name  : fbctl.h
 * Description: Command line parsing for the Broadcom Flow Bond Control Utility
 *******************************************************************************
 */
...
#define INVALID_COMMAND                         103

#define INVALID_OPTION                          104
#define INVALID_PARAMETER                       105
#define INVALID_NUMBER_OF_OPTIONS               106
#define INVALID_NUMBER_OF_PARAMETERS            107
