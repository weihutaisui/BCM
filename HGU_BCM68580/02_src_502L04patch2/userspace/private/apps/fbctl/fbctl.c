...
{
    int nRet = FBOND_SUCCESS, nNumOptInfo = 0, nArgType = 0;
    ...
    *pnArgNext = 0;
    ...
    do
    {
        ...
        case ARG_TYPE_OPTION:
            ...
            {
                nRet = INVALID_NUMBER_OF_OPTIONS;
        ...
        case ARG_TYPE_PARAMETER:
            ...
            else
            {
                ...
                {
                    pCurrOpt = &OptInfo[nNumOptInfo++];
                    pCurrOpt->pOptName = pCmd->szCmdName;
                    pCurrOpt->pParms[pCurrOpt->nNumParms++] = *argv;
                }
            }
            (*pnArgNext)++;
    ...
    } while ( (nRet == FBOND_SUCCESS) && (nArgType!=ARG_TYPE_COMMAND) );

    if ( nRet == FBOND_SUCCESS )
