...
#define	UPNP_ERROR(args) cmsLog_error args

#define	UPNP_TRACE(args) cmsLog_debug args

#define	UPNP_MAPPING(args) cmsLog_debug args
#define	UPNP_INFORM(args) cmsLog_notice args
#define	UPNP_HTTP(args) cmsLog_debug args
#define	UPNP_SUBSCRIBE(args) cmsLog_debug args
