 ...
 *******************************************************************************
 * File Name  : gmacctl.h
 * Description: Command line parsing for the Broadcom GMAC Control Utility
 *******************************************************************************
 */
...
/* Return codes. */
#define GMACCTL_GENERAL_ERROR                 100
#define GMACCTL_NOT_FOUND                     101
#define GMACCTL_ALLOC_ERROR                   102
#define GMACCTL_INVALID_COMMAND               103

#define GMACCTL_INVALID_OPTION                104
#define GMACCTL_INVALID_PARAMETER             105
#define GMACCTL_INVALID_NUMBER_OF_OPTIONS     106
#define GMACCTL_INVALID_NUMBER_OF_PARAMETERS  107
