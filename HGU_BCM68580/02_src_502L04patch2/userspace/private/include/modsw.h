...
CmsRet modsw_addEeEntry(const char *name,
                        ...
                        const char *appDigest,
                        const char *maniDigest,
                        int diskSpace,
                        CmsEntityId eeEid);
...
CmsRet modsw_addEuEntryLocked(const char *euId, const char *alias, const char *name, const char *mngrAppName,
                              const char *execEnvLabel, const char *execEnvRef,
                              const char *vendor, const char *version,
                              const char *description, const char *username, UINT32 bundleId,
