 ...
 * Definitions and APIs are used by omcipm thread and library
 */
...
/*
 * Parameter tags indicating whether the parameter is an input, output,
 * or input/output argument.
 */
...
/*
 * The multicast polling interval must be used as divisor in PM in order to 
 * get correct "Current multicast bandwidth" estimation.
 */
...
#define MOCA_PORT_MAX GPON_PHY_MOCA_PORT_MAX
...
#define OMCI_LINE_FULL_DUPLEX 0x00
...
#define ETHERNET_PORT_MAX GPON_PHY_ETH_PORT_MAX
