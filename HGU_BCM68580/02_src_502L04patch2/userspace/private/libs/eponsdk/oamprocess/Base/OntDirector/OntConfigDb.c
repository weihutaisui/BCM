...
static U8 BULK userLinkCount = 0;
static U8 BULK userUpstreamQueueTotal = 0;
...
///
/// \return
/// bytes in manufacturer name
////////////////////////////////////////////////////////////////////////////////
//extern
U8 OntCfgManNameGet(U8  * name, U8 bufSize)
    {
    U8 len = strlen((char *)EponDevVendorName);

    len = (len < bufSize)?len:bufSize;
    memcpy(name, EponDevVendorName, len);
    return len;
    }
...
DateOfMan OntCfgDateOfManGet(void)
    {
    DateOfMan date;
	memset(&date,0,sizeof(DateOfMan));
    return date;
    }
...
void OntCfgDbInit(void)
    {
    userLinkCount = EponDevNumLinks;
    userUpstreamQueueTotal = 0;
    }  // OntCfgDbInit
...
void OntCfgDbUpInfoSet(U8 linkCount, U8 queueCount)
    ...
    userUpstreamQueueTotal = queueCount;
    }
