                                 ...
                                 UINT16 ownerId)
{
   ...
   ret = odl_setInstanceOwnerId(oid, iidStack, ownerId);
                                 ...
                                 UINT16 *ownerId)
{
   ...
   ret = odl_getInstanceOwnerId(oid, iidStack, ownerId);
...
CmsRet cmsObj_dumpObjectLegacy(const void *mdmObj)
{
    ...
    if(mdmObj == NULL)
    {
        cmsLog_error("Invalid Object 0x%08X", mdmObj);
        lck_trackExit(__FUNCTION__);
        return CMSRET_INVALID_ARGUMENTS;
    }
    ...
    if(objNode == NULL)
    {
        cmsLog_error("Could not find Object 0x%08X", mdmObj);
        lck_trackExit(__FUNCTION__);
        return CMSRET_INVALID_ARGUMENTS;
    }
...
CmsRet cmsObj_compareObjects(const void *mdmObj1, const void *mdmObj2, paramNodeList **differedParamList)
{
    ...
    *differedParamList = NULL;
    ...
    if (*((MdmObjectId *) mdmObj1) != *((MdmObjectId *) mdmObj2))
    {
        lck_trackExit(__FUNCTION__);
        return CMSRET_INVALID_ARGUMENTS;
    }
    ...
    if (objNode == NULL)
    {
        cmsLog_error("Could not find Object 0x%08X", mdmObj1);
        lck_trackExit(__FUNCTION__);
        return CMSRET_INVALID_ARGUMENTS;
    }
       ...
       switch(paramNode->type)
       {
          ...
          case MPT_UNSIGNED_INTEGER:
          {
             ...
             if (*(UINT32 *)pObjVal1 != *(UINT32 *)pObjVal2)
             {
                struct paramNodeList *differedNode = cmsMem_alloc(sizeof(struct paramNodeList), ALLOC_ZEROIZE); ;
                differedNode->offset = paramNode->offsetInObject;
                //differedNode->value = pMdmObj1 + (paramNode->offsetInObject/sizeof(UINT32));
                //differedNode->size = sizeof(UINT32);
          ...
          case MPT_LONG64:
          {
             ...
             if (*(SINT64 *)pObjVal1 != *(SINT64 *)pObjVal2) 
             {
                ...
                differedNode->offset = paramNode->offsetInObject;
                //differedNode->value = pMdmObj1 + (paramNode->offsetInObject/sizeof(SINT32));
                //differedNode->size = sizeof(SINT32) * 2;
          ...
          case MPT_UNSIGNED_LONG64:
          {
             ...
             if (*(UINT64 *)pObjVal1 != *(UINT64 *)pObjVal2) 
             {
                ...
                differedNode->offset = paramNode->offsetInObject;
                //differedNode->value = pMdmObj1 + (paramNode->offsetInObject/sizeof(UINT32));
                //differedNode->size = sizeof(UINT32) * 2;
