...
{
   CmsRet ret = CMSRET_SUCCESS;
   char cmd[CERT_BUFF_MAX_LEN], fname[CERT_BUFF_MAX_LEN], data[CERT_BUFF_MAX_LEN];
...
{
   char fn[BUFLEN_264], certPath[BUFLEN_264];
   FILE *fp = NULL;
...
{
   char fn[BUFLEN_264], certPath[BUFLEN_264], cmd[BUFLEN_264];
...
{
   CmsRet ret = CMSRET_SUCCESS;
   char certTmpName[BUFLEN_264], certn[BUFLEN_264], reqn[BUFLEN_264];
   char cmd[BUFLEN_264], outn1[BUFLEN_264], outn2[BUFLEN_264];
   char sslApp[BUFLEN_40];
...
{
   CmsRet ret = CMSRET_SUCCESS;
   char certTmpName[BUFLEN_264], certn[BUFLEN_264];
   char cmd[BUFLEN_264], subject[BUFLEN_264], outn[BUFLEN_264];
   char sslApp[BUFLEN_40], subhead[] = "/";
   FILE *fcert = NULL;
    ...
    char *subject) 
{
   ...
   UINT32 count = 0;
   char certTmpName[BUFLEN_264], certn[BUFLEN_264];
   char cmd[BUFLEN_264], outn[BUFLEN_264];
...
CmsRet rutCert_processImportedCert(CertificateCfgObject *certCfg) 
{
   ...
   if (cmsUtl_strcmp(certCfg->type, CERT_TYPE_CA) !=0) 
   {
      char certTmpName[BUFLEN_264], privkeyn[BUFLEN_264];
      char cmd[BUFLEN_264], outn[BUFLEN_264], buf[BUFLEN_40];
      char sslApp[BUFLEN_40];
