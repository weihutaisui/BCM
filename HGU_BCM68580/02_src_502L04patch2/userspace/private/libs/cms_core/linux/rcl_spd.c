...
CmsRet rcl_spdCfgObject( _SpdCfgObject *newObj,
                const _SpdCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_SPD, newObj->loggingLevel);

      rut_updateLogDestination(EID_SPD, newObj->loggingDestination);
   }
