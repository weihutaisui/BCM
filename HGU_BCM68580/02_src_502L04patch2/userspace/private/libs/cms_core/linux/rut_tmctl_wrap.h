...
#define rutomci_tmctl_portTmInit(arg...)      rutwrap_tmctl_portTmInit(TMCTL_USER_OMCI, ##arg)
...
#define rutsupper_tmctl_portTmInit(arg...)       rutwrap_tmctl_portTmInit(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_portTmUninit(arg...)     rutwrap_tmctl_portTmUninit(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_getQueueCfg(arg...)      rutwrap_tmctl_getQueueCfg(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_delQueueCfg(arg...)      rutwrap_tmctl_delQueueCfg(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_getPortShaper(arg...)    rutwrap_tmctl_getPortShaper(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_setPortShaper(arg...)    rutwrap_tmctl_setPortShaper(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_getQueueDropAlg(arg...)  rutwrap_tmctl_getQueueDropAlg(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_setQueueDropAlg(arg...)  rutwrap_tmctl_setQueueDropAlg(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_getQueueStats(arg...)    rutwrap_tmctl_getQueueStats(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_getPortTmParms(arg...)   rutwrap_tmctl_getPortTmParms(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_setQueueCfg(arg...)      rutwrap_tmctl_setQueueCfg(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_getQueueStats(arg...)    rutwrap_tmctl_getQueueStats(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_setQueueDropAlgExt(arg...) rutwrap_tmctl_setQueueDropAlgExt(TMCTL_USER_MAX, ##arg)
#define rutsupper_tmctl_setQueueSize(arg...)     rutwrap_tmctl_setQueueSize(TMCTL_USER_MAX, ##arg)
