...
CmsRet stl_lanWlanObject(_LanWlanObject *obj, const InstanceIdStack *iidStack __attribute__((unused)))
{
   UBOOL8 isLinkUp;
   ...
   rut_getIntfStats(obj->X_BROADCOM_COM_IfName, &(obj->totalBytesReceived), &(obj->totalPacketsReceived), 
        ...
        &(obj->totalBytesSent), &(obj->totalPacketsSent), 
