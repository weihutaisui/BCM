...
CmsRet rcl_uspdCfgObject( _UspdCfgObject *newObj,
                const _UspdCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_USPD, newObj->loggingLevel);

      rut_updateLogDestination(EID_USPD, newObj->loggingDestination);
   }
