...
/** Create setkey and racoon configuration file.
 * 
 ...
 * @return CmsRet enum.
 */     
CmsRet rutIPSec_doSetkeyRacoon(void);
CmsRet rutIPSec_doSetkeyRacoon_igd(void);
CmsRet rutIPSec_doSetkeyRacoon_dev2(void);
#if defined(SUPPORT_DM_LEGACY98)
#define rutIPSec_doSetkeyRacoon()  rutIPSec_doSetkeyRacoon_igd()
#elif defined(SUPPORT_DM_HYBRID)
#define rutIPSec_doSetkeyRacoon()  rutIPSec_doSetkeyRacoon_igd()
#elif defined(SUPPORT_DM_PURE181)
#define rutIPSec_doSetkeyRacoon()  rutIPSec_doSetkeyRacoon_dev2()
#elif defined(SUPPORT_DM_DETECT)
#define rutIPSec_doSetkeyRacoon()   (cmsMdm_isDataModelDevice2() ?   \
                                  rutIPSec_doSetkeyRacoon_dev2()   : \
                                  rutIPSec_doSetkeyRacoon_igd())
#endif


/** Restart racoon with new configuration. 
 * 
 * This is a convenience function made available to other RCL handler functions.
 * This function is also called by the DAL.
 * 
