                                   ...
                                   SINT32 delta)
{
   ...
   case MDMOID_DEV2_CELLULAR_INTERFACE:
      num = &(((_Dev2CellularObject*) mdmObj)->interfaceNumberOfEntries);
      break;
	  
   case MDMOID_DEV2_CELLULAR_ACCESS_POINT:
      num = &(((_Dev2CellularObject*) mdmObj)->accessPointNumberOfEntries);
      break;
#endif
