...
/*This function will be used to dynamic decide wlan adapter numbers*/
...
/* This function get Virt ssid Intf number */
int wlgetVirtIntfNo( int idx __attribute__((unused)))
{
#ifdef DESKTOP_LINUX
   return 4;
#else
   return wlcsm_wl_get_mbss_num(idx);
#endif
}
