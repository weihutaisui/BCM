 ...
 */
MdmLibraryContext mdmLibCtx={FALSE, 0, 0, CMS_INVALID_PID, NULL, UNINITIALIZED_SHM_ID, NULL, ALLOC_ZEROIZE, FALSE, 0, FALSE, TRUE};
...
CmsEntityId fullWriteAccessEidArray[] = {EID_SMD, EID_SSK,
                       ...
                       EID_VOICE, EID_DECT, EID_DECTDBGD,
                       EID_EPON_APP, EID_HOMEPLUGD, EID_HOMEPLUGCTL,
                       EID_BMUD, EID_1905, EID_SPD, EID_PMD, EID_INVALID};
