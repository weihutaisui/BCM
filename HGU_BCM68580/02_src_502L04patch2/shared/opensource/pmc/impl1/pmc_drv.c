...
int GetRevision(uint32_t *value)
{
...
static void pmc_boot(void)
{
...
#if defined (_BCM96846_) || defined (_BCM96856_)
    {
        ...
        {
            printf("PMC rev: %d.%d.%d running\n", (revision>>28) & 0xf, (revision >> 20) & 0xff, (revision & 0xfffff));
        }
...
#if (defined (_BCM96846_) || defined(_BCM96856_)) && defined(CFG_RAMAPP)
    dump_swregs();
