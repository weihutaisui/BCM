...
#include "bcm_auth_if.h"
    ...
    defined(_BCM96836_) || defined(_BCM96846_) || defined(_BCM96856_)
...
#include "bcm_map.h"
    ...
    ((defined(_BCM963138_) || defined(_BCM963148_) || \
     ...
     defined(_BCM963158_) || defined(_BCM96836_)) || \
...
#if (! defined(_BCM963158_)) && (! defined(_BCM96836_) && !defined(_BCM96846_) && !defined(_BCM96856_))
    *(uint32_t *)(PKA_BASE + PKA_PERM) = 0;
#endif
#endif

#if (INC_BTRM_BUILD==1) && \
    (defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM963158_) || defined(_BCM96836_) || defined(_BCM96846_) || defined(_BCM96856_))
    uint32_t binLen = 0;
 ...
 */
    ...
    (! defined(_BCM96836_)) && (! defined(_BCM96856_)) && (! defined(_BCM963158_)) && (! defined(_BCM96846_)) && (INC_BTRM_BOOT==0)
