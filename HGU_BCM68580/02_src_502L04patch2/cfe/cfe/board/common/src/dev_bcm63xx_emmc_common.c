                                       ...
                                       int (*bootfs_parsefunc)( char * , char * , char * , int * ) )
{
    ...
    for( i=PRIMARY_IMG; i<=SECONDARY_IMG; i++ )
    {
        ...
        if( !img_idx || (img_idx && (*img_idx == 0)) )
        {
            ...
            {
                sel_seqnum   = (seq2 > seq1) ? seq1 : seq2;
                sel_cm_flag = (seq2 > seq1) ? cm_flag1 : cm_flag2;
            }
        ...
        /* Try and load imagedata from selected partition. 
         * Only load images which are committed OR which
         * have the magic 998 sequence numbers indicating 
         * an image from a flash programmer */
        if( sel_cm_flag || sel_seqnum == 998 )
        {
        ...
        *img_idx = 0;
        ...
        /* swap sequence numbers to tryout secondary images */
        temp = seq1;
        seq1 = seq2;
        seq2 = temp;
    }
