...
#elif defined(_BCM94908_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_)
...
#elif defined(_BCM94908_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_)
...
#else
#if defined(_BCM963148_) || defined(_BCM963138_) || defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_)
...
#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM96856_) || defined(_BCM963158_) || defined(_BCM96846_)
    else
    {
...
#if defined(_BCM963158_) || defined(_BCM96858_) || defined(_BCM96848_) || defined(_BCM96838_)
// if pureUBI check if we need to boot the other image
    ...
    for( k = 0; k < 2; k++ )
    {
        ...
        uint32_t isize = 0;
#if defined(_BCM96838_) || defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_) ||\
((INC_BTRM_BOOT==1) && (defined(_BCM963268_) || defined(_BCM963381_) || defined(_BCM963138_) || defined(_BCM963148_)))
...
#if defined(_BCM96838_) || defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM96856_) || defined(_BCM963158_) || defined(_BCM96846_) || \
   ((INC_BTRM_BOOT==1) && (defined(_BCM963268_) || defined(_BCM963381_) || defined(_BCM963138_) || defined(_BCM963148_)))
            // If secure boot, compressed, encrypted CFE RAM
            // is authenticated within internal memory
            if (boot_secure)
            ...
            res = parse_ubi(0, buf, rfsi->start_blk, rfsi->end_blk, len, VOLID_UBIFILES, g_fname, (char *)pucDest, 0, 0, read_blk, 0, 0, 0, 0);
            if (!res) {
 ...
 ((INC_BTRM_BOOT==1) && (defined(_BCM963268_) || defined(_BCM963381_) || defined(_BCM963138_) || defined(_BCM963148_)))
            if (boot_secure)
            {
               ...
               ROM_PARMS_SET_DEVEL_ARG(pucEntry, bootArgs.otpDieFallThru);
#endif
            }
#endif
