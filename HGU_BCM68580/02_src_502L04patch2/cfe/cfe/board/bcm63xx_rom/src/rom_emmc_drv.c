...
void emmc_run_image( char * loaded_image, int image_size, int boot_secure , int image_num, unsigned long rom_param)
{
...
#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || \
...
#endif
   {
...
#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM96856_) || defined(_BCM963158_) || ((INC_BTRM_BOOT==1) && defined(_BCM963138_))
        if (boot_secure)
        {
    ...
    /* Error occurred. */
#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) ||defined(_BCM96836_) || defined(_BCM96856_) || \
...
int rom_emmc_boot(unsigned char * dma_addr, unsigned long rom_param)
{
    int bootImg=0; 
    int imageNum=0 ;
    char file_name[20] = NAND_CFE_RAM_NAME;
    int file_length = 0;
    /* static because of stack overrun issues */

#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM963138_) || defined(_BCM96836_) || \
    ...
    if (boot_secure)
       strcpy(file_name, NAND_CFE_RAM_SECBT_NAME);
#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96856_)
    else
    {
       ...
       if (boot_mfg_secure)
       {
          strcpy(file_name, NAND_CFE_RAM_SECBT_MFG_NAME);
          boot_secure = 1;
       }
    }
#endif
    ...
    if (emmc_initialized) 
    {
        ...
        if( (file_length = load_file_from_next_bootfs( file_name, (char*)temp_data_buffer, &bootImg, &imageNum, &parse_emmc_bootfs )) < 0 )
        {
        ...
        /* 6-Run loaded image */
        emmc_run_image( (char*)temp_data_buffer, file_length, boot_secure, imageNum, rom_param);
