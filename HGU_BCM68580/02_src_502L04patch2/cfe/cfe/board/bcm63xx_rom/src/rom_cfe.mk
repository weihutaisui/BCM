...
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_4908_6858_63158_6846_6836_6856_),)
INC_NVRAM_MIRRORING=1
endif

ifeq ($(strip $(BLD_EMMC)),1)
# BUILD EMMC flash boot loader
# supported chips are 63138, 4908, 6858, 63158, 6836, 6856
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_63138_4908_6858_63158_6836_6856_),)
...
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_63138_63148_4908_6858_63158_6846_6836_6856_),)
INC_MEMSYS_INIT=1
endif
...
CFLAGS += -DCONFIG_BCM_CHIP_REV=$(CONFIG_BCM_CHIP_REV)
