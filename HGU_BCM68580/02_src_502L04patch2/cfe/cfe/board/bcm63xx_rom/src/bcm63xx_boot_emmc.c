...
{
#if defined(_BCM94908_) || defined(_BCM963158_) || defined(_BCM96836_) || defined(_BCM96856_)
...
void bootImageFromEmmc(unsigned long rom_param)
{
#if (CFG_COPY_PSRAM==1)
...
void bootEmmc(void)
{
    if (strap_check_emmc())
    {
        bootImageFromEmmc(rom_option); /* Will not return. */
    }
}
