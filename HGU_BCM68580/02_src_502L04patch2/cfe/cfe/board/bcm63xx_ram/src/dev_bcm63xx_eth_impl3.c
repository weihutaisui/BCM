...
static int cpu_ring_and_scheduler_init(void)
{
...
#ifdef MAC_LPORT
    uint32_t flow_map[] = {BB_ID_RX_XLMAC0_0_10G, BB_ID_RX_XLMAC0_1_2P5G, BB_ID_RX_XLMAC0_2_1G, BB_ID_RX_XLMAC0_3_1G,
        BB_ID_RX_XLMAC1_0_RGMII, BB_ID_RX_XLMAC1_1_RGMII, BB_ID_RX_XLMAC1_2_RGMII};
#else
    ...
    rdd_ring_init(FEED_RING_ID, rdpa_ring_feed, cpu_ring_head, CFE_CPU_FEED_RING_SIZE,
        sizeof(RDD_CPU_FEED_DESCRIPTOR_DTS), 0, CFE_CPU_FEED_RING_SIZE - 1, 0);
...
static void bcm63xx_impl3_ether_poll(cfe_devctx_t *ctx, int64_t ticks)
{
    bcmenet_sc_t *sc = (bcmenet_sc_t *)ctx->dev_softc;
    int i, link;
#if defined(CONFIG_BRCM_IKOS) && ( defined(_BCM96836_) || defined(_BCM96846_) || defined(_BCM96856_))
