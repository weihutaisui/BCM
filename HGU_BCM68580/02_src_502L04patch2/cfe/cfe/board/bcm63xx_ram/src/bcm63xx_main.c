...
#if defined (_BCM96858_) || defined(_BCM94908_) || defined(_BCM96836_) || defined(_BCM963158_) || \
...
unsigned int cfe_startflags = 0;
    ...
    defined (_BCM96848_) || defined (_BCM96858_) || defined(_BCM96836_)
static int cfe_bus_speed = 0;
static int cfe_ddr_speed = 0;
#endif
#if defined (_BCM96838_) || defined (_BCM96848_) || defined (_BCM96858_) || defined(_BCM96836_) || \
    defined(_BCM96846_) || defined (_BCM96856_)
...
static void cfe_startup_info(void)
{
...
#elif defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96856_)
    char *nr_cores = NULL;
#if defined(_BCM96858_)
    uint32 val;
    ...
    nr_cores = "Quad";
#elif defined(_BCM96836_) || defined(_BCM96856_)
    uint32 val;
    if ( !bcm_otp_get_nr_cpus(&val) )
    {
        if (val == 0)
...
#endif
#if _BCM963268_ ||     defined (_BCM96838_) || defined (_BCM96848_) || defined (_BCM96858_) || defined (_BCM96836_)
    ...
    xprintf("\n");
#endif
#if defined(_BCM96838_) || defined(_BCM96848_) || defined(_BCM96858_) || defined (_BCM96836_) || defined(_BCM96846_) || defined(_BCM96856_)
...
static void cfe_set_prompt(void)
{
    ...
    defined(_BCM96836_) || defined(_BCM96856_)
