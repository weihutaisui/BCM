...
#include "btrm_if.h"
#if (defined (_BCM96838_) || defined (_BCM96848_) || defined (_BCM96858_) || defined (_BCM96836_) || defined (_BCM96846_) || defined (_BCM96856_)) && (NONETWORK == 0)
...
#if (defined (_BCM96836_) || defined (_BCM96846_) || defined (_BCM96856_)) && (NONETWORK == 0)
...
#endif
#if (defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM96846_) || defined(_BCM96856_)) && (NONETWORK == 0)
...
static int ui_cmd_erase_nand(ui_cmdline_t *cmd,int argc,char *argv[])
{
    ...
    char *flag;
#if defined(_BCM963138_) || defined(_BCM963148_) || defined (_BCM94908_) || defined (_BCM96858_) || defined (_BCM96836_)
    ...
    char *flag;
#if defined(_BCM963138_) || defined(_BCM963148_) || defined (_BCM94908_) || defined (_BCM96858_) || defined (_BCM96836_) || defined (_BCM96856_)
    unsigned char *pBuf = NULL;
#endif
    unsigned char *buf = NULL;
    int i, blk_end, blkSize = 0;
...
static int ui_cmd_write_whole_image(ui_cmdline_t *cmd,int argc,char *argv[])
{
    char hostImageName[BOOT_FILENAME_LEN + BOOT_IP_LEN];
    char *imageName;
#if defined (_BCM963138_) || (_BCM963148_) || defined (_BCM94908_) || defined (_BCM96858_) || defined (_BCM96836_) || defined (_BCM96856_)
    char *pmcName = NULL;
#endif
    uint8_t *ptr = (uint8_t *) cfe_get_mempool_ptr();
    int res;
...
#error "SEC_S_SIGNATURE must be 4 byte aligned"
    ...
    la.la_entrypt = (long)image_hdr.entrypt;
              ...
              defined(_BCM963138_) || defined(_BCM963148_) || defined(_BCM96836_) || \
...
#endif
    {
        ret = decompressLZMA((unsigned char*)image, image_hdr.len, (unsigned char*)la.la_address, 23*1024*1024) < 0;
    }
...
static int ui_cmd_phy(ui_cmdline_t *cmd,int argc,char *argv[])
{
    ...
    !defined (_BCM947189_) && !defined(_BCM96836_) && !defined (_BCM96846_) && !defined (_BCM96856_)
    if (argc < 2) {
...
WrongParams:
      printf("%s\n", lport_phy_usage);
      return -1;
#elif  defined(_BCM96836_) || defined (_BCM96846_) || defined (_BCM96856_)
      char *pszPhyId = cmd_getarg(cmd, 0);
      char *pszReg = cmd_getarg(cmd, 1);
      char *pszVal = cmd_getarg(cmd, 2);
      int phyid;
...
#if (defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM963158_) || defined(_BCM963138_)  || defined(_BCM96836_) || defined(_BCM963381_) || defined (_BCM96856_) || defined(_BCM96846_)) && ( (INC_NAND_FLASH_DRIVER==1) || (INC_EMMC_FLASH_DRIVER==1) )
...
/* Exception case handling to detect A0 image on B0 and vice versa */
    ...
    !defined(_BCM96858_) && !defined(_BCM96836_) && !defined (_BCM96846_) && !defined(_BCM947189_) && !defined(_BCM96856_)
    bcm_ethsw_init();
#endif
    ...
    ui_init_bcm63xx_cmds();
#if (defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM963158_) || defined(_BCM96836_) || defined(_BCM963381_)|| defined(_BCM963138_) || defined(_BCM96856_) || defined(_BCM96846_)) && ( (INC_NAND_FLASH_DRIVER==1) || (INC_EMMC_FLASH_DRIVER==1) )
    ui_init_otp_cmds();
#endif
