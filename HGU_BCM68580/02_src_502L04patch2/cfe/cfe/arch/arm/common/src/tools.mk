...
ifeq ($(strip ${CFG_ARMV8_AARCH64}),1)
   TOOLS :=$(TOOLCHAIN_BASE)/crosstools-aarch64-gcc-5.3-linux-4.1-glibc-2.24-binutils-2.25/usr/bin/
   TOOLPREFIX :=aarch64-buildroot-linux-gnu-
else
   TOOLS :=$(TOOLCHAIN_BASE)/crosstools-arm-gcc-5.3-linux-4.1-glibc-2.24-binutils-2.25/usr/bin/
