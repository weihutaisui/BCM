...
#if defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM96846_) || defined(_BCM96856_)
#define MEMC_DEBUG       1
#endif
#ifdef MEMC_DEBUG
...
#elif defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_)
...
#if defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_)
...
static mcbindex* memc_get_mcb(uint32_t memcfg)
{
    ...
    unsigned int freq = ((MISC->miscStrapBus & MISC_STRAP_DDR_FREQ_MASK) >> MISC_STRAP_DDR_FREQ_SHIFT);
    unsigned int density = ((MISC->miscStrapBus & MISC_STRAP_DDR_DENSITY_MASK) >> MISC_STRAP_DDR_DENSITY_SHIFT);
    mcbindex* pRet = &MCB[density*2 + freq];
#else
...
#if defined(_BCM96836_) || defined(_BCM96846_)
