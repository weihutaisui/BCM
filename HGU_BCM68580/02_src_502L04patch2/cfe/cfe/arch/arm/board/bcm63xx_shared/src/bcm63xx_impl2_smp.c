...
#if defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96856_) || defined(_BCM96846_)
    ARM_CONTROL_REG ctrl_reg;
#endif
#if defined(_BCM96858_)
    uint32_t rvbar = (uint32_t)vector;
#elif  defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96856_)
