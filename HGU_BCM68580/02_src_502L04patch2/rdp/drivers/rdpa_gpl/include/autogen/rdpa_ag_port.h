...
typedef enum {
    ...
    rdpa_port_attr_stat = 7, /* stat : RW : aggregate stat(rdpa_port_stat_t) : Port statistics */
    rdpa_port_attr_flow_control = 8, /* flow_control : RW : aggregate port_flow_control(rdpa_port_flow_ctrl_t) : The port flow control */
    rdpa_port_attr_mirror_cfg = 9, /* mirror_cfg : RW : aggregate port_mirror_cfg(rdpa_port_mirror_cfg_t) : Port mirroring configuration */
    rdpa_port_attr_vlan_isolation = 10, /* vlan_isolation : RW : aggregate vlan_isolation(rdpa_port_vlan_isolation_t) : LAN port VLAN isolation control */
    rdpa_port_attr_transparent = 11, /* transparent : RW : bool : LAN port transparent control */
    rdpa_port_attr_loopback = 12, /* loopback : RW : aggregate port_loopback_conf(rdpa_port_loopback_t) : Port loopbacks */
    rdpa_port_attr_mtu_size = 13, /* mtu_size : RW : number : Port MTU */
    rdpa_port_attr_cpu_obj = 14, /* cpu_obj : RW : object : CPU object for exception/forwarding-through-cpu packets */
    rdpa_port_attr_cpu_meter = 15, /* cpu_meter : RW : number : Index of per-port CPU meter */
    rdpa_port_attr_ingress_filter = 16, /* ingress_filter : RWF : aggregate[(rdpa_filter)] filter_ctrl(rdpa_filter_ctrl_t) : Ingress filter configuration per Port object */
    rdpa_port_attr_protocol_filters = 17, /* protocol_filters : RW : enum_mask : Protocol Filters define allowed traffic type */
