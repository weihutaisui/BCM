...
static inline int rdpa_vlan_mac_lookup_cfg_get(bdmf_object_handle mo_, rdpa_mac_lookup_cfg_t * mac_lookup_cfg_)
{
	...
	pa.mo = mo_;
	pa.ptr = (uint32_t)mac_lookup_cfg_;
