...
static int runner_init(int is_basic)
{
    ...
    rdd_init_params.dhd_hw_config.ddr_sop_offset = ((ddr_sop_offset0 + DHD_DATA_OFFSET + 3) >> 2) << 2;
#endif
...
static int dispatcher_reorder_init(void)
{
    ...
    /*  ***** number of cores should be set according to OTP ***** */
    /* 6836B0 - 6 cores */
    /* 6856   - 8 cores */
    for (core_index = 0; core_index < GROUPED_EN_SEGMENTS_NUM - 2; core_index++)
    {
