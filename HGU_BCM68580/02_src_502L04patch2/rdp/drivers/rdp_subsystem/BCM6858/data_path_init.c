...
static int natc_init(void)
{
...
#else
    natc_ddr_cfg_natc_ddr_size ddr_size = {ddr_size_128k, ddr_size_128k, ddr_size_128k, ddr_size_128k, ddr_size_128k, ddr_size_128k, ddr_size_128k, ddr_size_128k};
#endif
    ...
    cfg.ctrl_status.nat_hash_mode = hash_mode_crc32_high;
...
#else
    init_cfg.fpm_ug_thr[0].mid_thr = DS_FPM_UG_DEFAULT * 90 / 100;
    init_cfg.fpm_ug_thr[0].lower_thr = DS_FPM_UG_DEFAULT * 90 / 100;
#endif
