...
#define RDPA_MCAST_MEM_INFO_MAX RDD_IPTV_DDR_CONTEXT_TABLE_SIZE
...
#define RDPA_MCAST_MEM_INFO_MAX RDD_FC_MCAST_CONNECTION2_TABLE_SIZE
...
#define rdd_mcast_flow_t BL_LILAC_RDD_ADD_CONNECTION_DTE

#define RDD_MCAST_FLOW_CONTEXT_GET_EX(rdd_mcast_flow)                   \
    (&(rdd_mcast_flow)->context_entry.fc_mcast_flow_context_entry)
