...
const bdmf_attr_enum_table_t rdpa_wl_accel_enum_table =
{
    .type_name = "wl_accel_type", .help = "WLAN acceleration type",
    .values = {
        {"none", RDPA_WL_ACCEL_NONE},
        {"wfd", RDPA_WL_ACCEL_WFD},
        {"dhd_offload", RDPA_WL_ACCEL_DHD_OFFLOAD},
        {NULL, 0}
    }
};
