...
struct bdmf_aggr_type dhd_init_config_type =
{
    ...
    .fields = (struct bdmf_attr[]) {
        { .name = "rx_post_flow_ring_base_addr", .help = "Base address of RX Post FlowRing", .size = sizeof(void *),
            .type = bdmf_attr_pointer, .offset = offsetof(rdpa_dhd_init_cfg_t, rx_post_flow_ring_base_addr)
        },
        ...
        { .name = "dongle_wakeup_register", .help = "Runner-to-Dongle Wakeup Register", .size = sizeof(uint32_t),
