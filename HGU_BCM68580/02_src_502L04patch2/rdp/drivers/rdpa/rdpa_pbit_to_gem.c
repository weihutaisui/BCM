...
#define RDPA_PBIT_TO_GEM_MAX_TABLES 8 /* Max number of PBIT-to-GEM mapping tables */
...
static void pbit_to_gem_destroy(struct bdmf_object *mo)
{
    ...
    for (i = 0; i < RDPA_PBIT_NUM; i++)
    {
        rdd_us_pbits_to_wan_flow_entry_cfg((int)tbl->index, i, RDPA_LAST_GEM_INDEX);
    }
