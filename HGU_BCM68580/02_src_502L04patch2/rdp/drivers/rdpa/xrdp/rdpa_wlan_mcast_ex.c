...
int wlan_mcast_attr_ssid_stats_read_ex(struct bdmf_object *mo, bdmf_index index,
    rdpa_wlan_mcast_ssid_stats_t *rdpa_ssid_stats)
{
    /* temporary until dhd mcast is supported */
    rdpa_ssid_stats->bytes = 0;    
    rdpa_ssid_stats->packets = 0;
    return 0;
}
