    ...
    RDD_IPTV_DDR_CONTEXT_ENTRY_DTS *ddr_ctx_entry)
{
    ...
    if (replications_num)
    {
        ...
        /* 32 bytes per multicast replicated header - RDD define should be use here: TODO */
        ddr_ctx_entry->pool_num = FPM_POOL_ID_LAST -  ddr_ctx_entry->replications / (g_fpm_base_buffer_size / 64);
    }
