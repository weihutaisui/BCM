...
#define image_0_start_task_update_fifo_read_1st_wakeup_request		(0x548)
#define image_0_update_fifo_read_1st_wakeup_request		(0x548)
...
#define image_0_start_task_flush_task_1st_wakeup_request		(0x45C)
#define image_0_flush_task_1st_wakeup_request		(0x45C)
...
#define image_0_basic_scheduler_update_dwrr		(0x44C)
