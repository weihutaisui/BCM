...
static void image_0_context_set(uint32_t core_index)
{
    ...
    /* EPON UPDATE_FIFO_READ: thread 0 */
    ...
    /* SCHEDULING WAN: thread 3 */
    local_regs[IMAGE_0_TM_WAN_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_0, tx_task_1st_wakeup_request) << 16;
    local_regs[IMAGE_0_TM_WAN_THREAD_NUMBER][reg_id[12]] = (IMAGE_0_US_TM_BBH_TX_EGRESS_COUNTER_TABLE_ADDRESS << 16);
    local_regs[IMAGE_0_TM_WAN_THREAD_NUMBER][reg_id[11]] = BB_ID_TX_PON_ETH_PD | (IMAGE_0_COMPLEX_SCHEDULER_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_0_TM_WAN_THREAD_NUMBER][reg_id[9]]  = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_EPON_TM << 6)) | (IMAGE_0_US_TM_SCHEDULING_QUEUE_TABLE_ADDRESS << 16); 
    ...
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[13]] = IMAGE_0_DS_TM_SCHEDULING_AGGREGATION_CONTEXT_VECTOR_ADDRESS;
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[12]] = xrdp_virt2phys(&RU_BLK(QM), 0) + RU_REG_OFFSET(QM, GLOBAL_CFG_AGGREGATION_CONTEXT_VALID) +
    ...
    local_regs[IMAGE_0_TM_FLUSH_THREAD_NUMBER][reg_id[9]] = IMAGE_0_US_TM_SCHEDULING_AGGREGATION_CONTEXT_VECTOR_ADDRESS;
    ...
    local_regs[IMAGE_0_TM_BUDGET_ALLOCATION_US_THREAD_NUMBER][reg_id[13]] = (RDD_BASIC_RATE_LIMITER_TABLE_SIZE / 4) * sizeof(RDD_BASIC_RATE_LIMITER_DESCRIPTOR_DTS);
    ...
    local_regs[IMAGE_0_TM_BUDGET_ALLOCATION_DS_THREAD_NUMBER][reg_id[13]] = (RDD_BASIC_RATE_LIMITER_TABLE_SIZE / 4) * sizeof(RDD_BASIC_RATE_LIMITER_DESCRIPTOR_DTS);
    ...
    /* Overall budget allocation (for ovlr rl): thread 8 */
    ...
    local_regs[IMAGE_0_TM_UPDATE_FIFO_DS_THREAD_NUMBER][reg_id[12]] = (IMAGE_0_DS_TM_PD_FIFO_TABLE_ADDRESS << 16);
...
static void image_1_context_set(uint32_t core_index)
{
    ...
    local_regs[IMAGE_1_PROCESSING_WAN_DIRECT_THREAD_NUMBER][reg_id[9]] = IMAGE_1_RX_FLOW_TABLE_ADDRESS << 16 | IMAGE_1_PROCESSING_WAN_DIRECT_THREAD_NUMBER;
    local_regs[IMAGE_1_PROCESSING_WAN_DIRECT_THREAD_NUMBER][reg_id[10]] = BB_ID_DISPATCHER_REORDER;
    local_regs[IMAGE_1_PROCESSING_WAN_DIRECT_THREAD_NUMBER][reg_id[11]] = QM_QUEUE_CPU_RX_COPY_EXCLUSIVE | ( IMAGE_1_DIRECT_PROCESSING_EPON_CONTROL_SCRATCH_ADDRESS << 16 );
#ifndef _CFE_
    local_regs[IMAGE_1_PROCESSING_WAN_DIRECT_THREAD_NUMBER][reg_id[16]] = 
    ...
    /* CPU_RX_UPDATE_FIFO_READ: thread 1 */
    local_regs[IMAGE_1_PROCESSING_CPU_RX_UPDATE_FIFO_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, cpu_rx_update_fifo_wakeup_request) << 16;
    local_regs[IMAGE_1_PROCESSING_CPU_RX_UPDATE_FIFO_THREAD_NUMBER][reg_id[12]] = (((IMAGE_1_PROCESSING_CPU_RX_THREAD_NUMBER) << 4) + 9);
    local_regs[IMAGE_1_PROCESSING_CPU_RX_UPDATE_FIFO_THREAD_NUMBER][reg_id[11]] = IMAGE_1_UPDATE_FIFO_TABLE_ADDRESS;

    /* CPU_RX_FIFO_READ: thread 2 */
    local_regs[IMAGE_1_PROCESSING_CPU_RX_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, cpu_rx_wakeup_request) << 16;
    local_regs[IMAGE_1_PROCESSING_CPU_RX_THREAD_NUMBER][reg_id[14]] = IMAGE_1_CPU_RX_SCRATCHPAD_ADDRESS |
    ...
    local_regs[IMAGE_1_PROCESSING_CPU_RX_THREAD_NUMBER][reg_id[11]] = IMAGE_1_PD_FIFO_TABLE_ADDRESS | (IMAGE_1_CPU_RECYCLE_SRAM_PD_FIFO_ADDRESS << 16);

    /* CPU_RX_METER_BUDGET_ALLOCATOR: thread 3 */
    ...
    /* CPU_INTERRUPT_COALESCING: thread 5 */
    ...
    local_regs[IMAGE_1_PROCESSING_CPU_RX_COPY_UPDATE_FIFO_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, cpu_rx_copy_update_fifo_wakeup_request) << 16;
    local_regs[IMAGE_1_PROCESSING_CPU_RX_COPY_UPDATE_FIFO_THREAD_NUMBER][reg_id[12]] = (((IMAGE_1_PROCESSING_CPU_RX_COPY_THREAD_NUMBER) << 4) + 9);
    local_regs[IMAGE_1_PROCESSING_CPU_RX_COPY_UPDATE_FIFO_THREAD_NUMBER][reg_id[11]] = IMAGE_1_CPU_RX_COPY_UPDATE_FIFO_TABLE_ADDRESS;
    ...
    local_regs[IMAGE_1_PROCESSING_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = (IMAGE_1_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_COMPLETE_COMMON_RADIO_ENTRY_DTS)*0);
    local_regs[IMAGE_1_PROCESSING_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[11]] = 0;

    /* DHD_RX_COMPLETE_0: thread 15 */
...
static void image_2_context_set(uint32_t core_index)
{
    ...
    /* CPU_TX_UPDATE_FIFO_EGRESS: thread 0 */
    ...
    /* CPU_TX_UPDATE_FIFO_INGRESS: thread 1 */
...
#ifdef UNDEF	
	/* DHD_MCAST_UPDATE_FIFO: thread 15 */
    ...
    local_regs[IMAGE_2_IMAGE_2_DHD_MCAST_THREAD_NUMBER][reg_id[11]] = IMAGE_2_DHD_MCAST_PD_FIFO_TABLE_ADDRESS;
...
static void rdd_tm_actions_proj_init(void)
{
    ...
    uint16_t us_actions_arr[] = {
        ...
        [9]  = ADDRESS_OF(image_0, complex_rate_limiter_basic_scheduler_pir),
        [10] = ADDRESS_OF(image_0, basic_rate_limiter_complex_scheduler),
        [11] = ADDRESS_OF(image_0, ovl_rate_limiter),
        [12 ... 15] = ADDRESS_OF(image_0, scheduling_action_not_valid),
