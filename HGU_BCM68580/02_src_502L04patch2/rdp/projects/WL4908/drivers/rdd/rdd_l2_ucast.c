                                  ...
                                  rdpa_traffic_dir                 direction )
{
    ...
    if ( tries == (RDD_NAT_CACHE_LOOKUP_DEPTH_SIZE/2) )
    {
        ...
        RDD_NAT_CACHE_L2_LKP_ENTRY_BUCKET_OVERFLOW_COUNTER_READ ( bucket_overflow_counter, nat_cache_lkp_entry_ptr );
        bucket_overflow_counter++;
        RDD_NAT_CACHE_L2_LKP_ENTRY_BUCKET_OVERFLOW_COUNTER_WRITE ( bucket_overflow_counter, nat_cache_lkp_entry_ptr );
    }
