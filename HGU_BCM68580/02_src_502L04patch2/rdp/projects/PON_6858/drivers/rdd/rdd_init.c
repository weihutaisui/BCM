...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* FLUSH TASK: thread 2 */
    local_regs[IMAGE_0_DS_TM_FLUSH_THREAD_NUMBER][reg_id[18]] = (((drv_qm_get_ds_end() - (drv_qm_get_ds_start() &~ 0x1F)) / 8) << 16) + drv_qm_get_ds_start();
    ...
    local_regs[IMAGE_0_DS_TM_LAN7_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_0, tx_task_1st_wakeup_request) << 16;
    ...
    local_regs[IMAGE_0_DS_TM_LAN7_THREAD_NUMBER][reg_id[11]] = BB_ID_TX_XLMAC1_3_RGMII | (IMAGE_0_COMPLEX_SCHEDULER_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_0_DS_TM_FRAG0_THREAD_NUMBER][reg_id[14]] = IMAGE_0_G9991_CONTROL_SID_TABLE_ADDRESS + 0 * sizeof(RDD_BYTES_4_DTS);
    ...
    local_regs[IMAGE_0_DS_TM_FRAG1_THREAD_NUMBER][reg_id[14]] = IMAGE_0_G9991_CONTROL_SID_TABLE_ADDRESS + 1 * sizeof(RDD_BYTES_4_DTS);
    ...
    local_regs[IMAGE_0_DS_TM_FRAG2_THREAD_NUMBER][reg_id[14]] = IMAGE_0_G9991_CONTROL_SID_TABLE_ADDRESS + 2 * sizeof(RDD_BYTES_4_DTS);
    ...
    local_regs[IMAGE_0_DS_TM_FRAG3_THREAD_NUMBER][reg_id[14]] = IMAGE_0_G9991_CONTROL_SID_TABLE_ADDRESS + 3 * sizeof(RDD_BYTES_4_DTS);
    ...
    local_regs[IMAGE_0_DS_TM_SYSTEM_PORT_THREAD_NUMBER][reg_id[11]] = BB_ID_TX_XLMAC1_1_RGMII |
        ((IMAGE_0_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE_ADDRESS + BBH_ID_XLMAC1_1_RGMII * sizeof(RDD_BBH_TX_EGRESS_COUNTER_ENTRY_DTS)) << 16);
    local_regs[IMAGE_0_DS_TM_SYSTEM_PORT_THREAD_NUMBER][reg_id[10]] = (IMAGE_0_G9991_PD_FIFO_TABLE_ADDRESS + RDD_VPORT_ID_29 * 2 * sizeof(RDD_PROCESSING_TX_DESCRIPTOR_DTS) ) |
        ((IMAGE_0_DS_TM_BBH_QUEUE_TABLE_ADDRESS + BBH_ID_XLMAC1_1_RGMII * sizeof(RDD_BBH_QUEUE_DESCRIPTOR_DTS)) << 16);
#endif
#ifdef RDP_SIM
...
static void image_2_context_set(uint32_t core_index)
{
...
#if (defined(CONFIG_BCM_SPDSVC) || defined(CONFIG_BCM_SPDSVC_MODULE) || defined(CONFIG_BCM_SPDSVC_SUPPORT))
    /* SPEED SERVICE: thread 13 */
    local_regs[IMAGE_2_CPU_IF_2_SPDSVC_GEN_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, spdsvc_gen_wakeup_request) << 16;
    local_regs[IMAGE_2_CPU_IF_2_SPDSVC_GEN_THREAD_NUMBER][reg_id[9]] = ((BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_SPDSVC << 6)) << 16);
    local_regs[IMAGE_2_CPU_IF_2_SPDSVC_GEN_THREAD_NUMBER][reg_id[10]] = IMAGE_2_CPU_IF_2_SPDSVC_GEN_THREAD_NUMBER | (IMAGE_2_SPDSVC_GEN_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
#endif
#endif
    ...
    local_regs[IMAGE_2_CPU_IF_2_WAN_DIRECT_THREAD_NUMBER][reg_id[16]] =
        ADDRESS_OF(image_2, gpon_control_wakeup_request) << 16 | IMAGE_2_WAN_DIRECT_PROCESSING_PD_TABLE_ADDRESS;

    /* DIRECT PROCESSING : thread 7 */
    ...
    local_regs[IMAGE_2_CPU_IF_2_DIRECT_SYSTEM_PORT_THREAD_NUMBER][reg_id[16]] =
        ADDRESS_OF(image_2, direct_processing_wakeup_request) << 16 | IMAGE_2_SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE_ADDRESS;

    /* CPU_RX_FIFO_READ: thread 6 */
    ...
    /* For now TX_ABS_RECYCLE task only supports speed service. It will
     * need to be revisited once CPU TX from ABS address is implemented
     */

    /* TX_ABS_RECYCLE: thread 14 */
    local_regs[IMAGE_2_CPU_IF_2_TX_ABS_RECYCLE_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, tx_abs_recycle_wakeup_request) << 16 |
        IMAGE_2_TX_ABS_RECYCLE_UPDATE_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_2_CPU_IF_2_TX_ABS_RECYCLE_THREAD_NUMBER][reg_id[11]] = IMAGE_2_TX_ABS_RECYCLE_PD_FIFO_TABLE_ADDRESS;
    local_regs[IMAGE_2_CPU_IF_2_TX_ABS_RECYCLE_THREAD_NUMBER][reg_id[12]] = 0;
...
static void image_3_context_set(uint32_t core_index)
{
    ...
    /* FLUSH TASK: thread 4 */
    local_regs[IMAGE_3_US_TM_FLUSH_THREAD_NUMBER][reg_id[18]] = (drv_qm_get_us_end() - drv_qm_get_us_start() + 1) / 8;
...
static void rdd_actions_proj_init(void)
{
    ...
    uint16_t rule_actions_arr[] = {
        ...
        [2] = ADDRESS_OF(image_4, action_dei_rule_based),  // updated dynamicaly  according to policer result
    ...
    uint16_t iptv_actions_arr[] = {
        [0] = ADDRESS_OF(image_4, action_dscp_remarking_rule_based),
        [1] = ADDRESS_OF(image_4, action_no_fwd_iptv),
