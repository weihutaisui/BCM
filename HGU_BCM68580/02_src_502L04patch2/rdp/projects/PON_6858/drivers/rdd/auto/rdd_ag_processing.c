...
int rdd_ag_processing_vport_cfg_entry_get(uint32_t _entry, rdd_vport_cfg_entry_t *vport_cfg_entry)
{
    ...
    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_READ_G(vport_cfg_entry->flow_control_all_traffic, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_READ_G(vport_cfg_entry->flow_control_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_READ_G(vport_cfg_entry->flow_control_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_READ_G(vport_cfg_entry->flow_control_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
...
int rdd_ag_processing_vport_cfg_table_flow_control_all_traffic_set(uint32_t _entry, bdmf_boolean flow_control_all_traffic)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_WRITE_G(flow_control_all_traffic, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_all_traffic_get(uint32_t _entry, bdmf_boolean *flow_control_all_traffic)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_READ_G(*flow_control_all_traffic, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_broadcast_set(uint32_t _entry, bdmf_boolean flow_control_broadcast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_WRITE_G(flow_control_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_broadcast_get(uint32_t _entry, bdmf_boolean *flow_control_broadcast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_READ_G(*flow_control_broadcast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_multicast_set(uint32_t _entry, bdmf_boolean flow_control_multicast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_WRITE_G(flow_control_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_multicast_get(uint32_t _entry, bdmf_boolean *flow_control_multicast)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_READ_G(*flow_control_multicast, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_unknown_da_set(uint32_t _entry, bdmf_boolean flow_control_unknown_da)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_WRITE_G(flow_control_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);

    return BDMF_ERR_OK;
}

int rdd_ag_processing_vport_cfg_table_flow_control_unknown_da_get(uint32_t _entry, bdmf_boolean *flow_control_unknown_da)
{
    if(_entry >= RDD_VPORT_CFG_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_READ_G(*flow_control_unknown_da, RDD_VPORT_CFG_TABLE_ADDRESS_ARR, _entry);
