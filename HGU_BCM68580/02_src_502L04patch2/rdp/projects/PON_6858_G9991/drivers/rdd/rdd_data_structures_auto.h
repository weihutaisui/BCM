...
#define RDD_DS_TM_BBH_TX_QUEUE_ID_TABLE_SIZE     4
typedef struct
{
	RDD_BYTES_4_DTS	entry[ RDD_DS_TM_BBH_TX_QUEUE_ID_TABLE_SIZE ];
}
...
/* >>>SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE */
typedef struct
{
	RDD_PROCESSING_RX_DESCRIPTOR_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE_DTS;

extern uint32_t RDD_SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE_PTR(core_id)	( RDD_SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_SYSTEM_PORT_DIRECT_PROCESSING_PD_TABLE_ADDRESS_ARR[core_id] ))
...
#define RDD_PACKET_BUFFER_CLASSIFICATION_RESULTS_NUMBER	8
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_FORCE_IC_IP_FLOW_DTS;

extern uint32_t RDD_FORCE_IC_IP_FLOW_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_FORCE_IC_IP_FLOW_PTR(core_id)	( RDD_FORCE_IC_IP_FLOW_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_FORCE_IC_IP_FLOW_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	...
	uint8_t	ingress_filter_profile	:6	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint8_t	ingress_filter_profile	:6	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	reserved              	:2	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#endif
...
typedef struct
{
	...
	uint32_t	flow_control_all_traffic     	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	flow_control_broadcast       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	flow_control_multicast       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	flow_control_unknown_da      	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_READ_G(r, g, idx)               GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 7, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 7, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_READ(r, p)                      FIELD_MREAD_8((uint8_t *)p + 2, 7, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_WRITE(v, p)                     FIELD_MWRITE_8((uint8_t *)p + 2, 7, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 6, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 6, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 2, 6, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 2, 6, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 5, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 5, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 2, 5, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 2, 5, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 4, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_VPORT_CFG_ENTRY_DTS) + 2, 4, 1, v)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_READ(r, p)                       FIELD_MREAD_8((uint8_t *)p + 2, 4, 1, r)
#define RDD_VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_WRITE(v, p)                      FIELD_MWRITE_8((uint8_t *)p + 2, 4, 1, v)
...
typedef enum
{
	...
	DISP_REOR_VIQ_SPDSVC                 = 29,
	DISP_REOR_VIQ_DS_TM_FLUSH_BBH_2_3    = 30,
	DISP_REOR_VIQ_LAST                   = 30
} rdd_disp_reor_viq;
/* <<<RDD_DISP_REOR_VIQ */
...
typedef enum
{
	...
	CLASSIFICATION_RESULT_INDEX_BRIDGE_OR_TCAM_IC_IP_FLOW    = 7,
...
typedef enum
{
	...
	COUNTER_G9991_SOF_AFTER_SOF                     = 93,
	COUNTER_G9991_MOF_EOF_WITHOUT_SOF               = 94,
	COUNTER_G9991_REASSEMBLY_ERROR                  = 95,
	COUNTER_LAST_NON_DHD                            = 95,
	COUNTER_DHD_RX_DROP_0                           = 96,
	COUNTER_DHD_RX_DROP_1                           = 97,
	COUNTER_DHD_RX_DROP_2                           = 98,
	COUNTER_DHD_TX_FPM_USED_0                       = 99,
	COUNTER_DHD_TX_FPM_USED_1                       = 100,
	COUNTER_DHD_TX_FPM_USED_2                       = 101,
	COUNTER_DHD_TX_FPM_DROP_0                       = 102,
	COUNTER_DHD_TX_FPM_DROP_1                       = 103,
	COUNTER_DHD_TX_FPM_DROP_2                       = 104,
	COUNTER_DHD_TX_DROP_0_SSID_0                    = 105,
	COUNTER_DHD_TX_DROP_1_SSID_0                    = 121,
	COUNTER_DHD_TX_DROP_2_SSID_0                    = 137,
	COUNTER_DHD_TX_FR_FULL_0_AC_0                   = 153,
	COUNTER_DHD_TX_FR_FULL_1_AC_0                   = 158,
	COUNTER_DHD_TX_FR_FULL_2_AC_0                   = 163,
	COUNTER_RX_WAN_PORT_DROP                        = 168,
	COUNTER_LAST                                    = 168
} rdd_counter;
/* <<<RDD_COUNTER */
...
typedef enum
{
	...
	PORT_MCST_BCST_GROUP_RX_BROADCAST_PKT         = 40,
	PORT_MCST_BCST_GROUP_TX_MULTICAST_PKT         = 80,
	PORT_MCST_BCST_GROUP_TX_BROADCAST_PKT         = 120,
	PORT_MCST_BCST_GROUP_TX_BROADCAST_PKT_LAST    = 159,
	PORT_MCST_BCST_GROUP_LAST                     = 159
} rdd_port_mcst_bcst_group;
/* <<<RDD_PORT_MCST_BCST_GROUP */
...
#define PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_F_OFFSET                    8
#define PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_F_WIDTH                     4
#define PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_OFFSET                      2
#define PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_F_OFFSET_MOD8               0
#define PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_F_OFFSET                         0
#define PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_F_WIDTH                          8
#define PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_OFFSET                           3
...
typedef struct
{
	...
	uint32_t	reserved_1                                                                           	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 2, 0, 4, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 2, 0, 4, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_READ(r, p)                  FIELD_MREAD_8((uint8_t *)p + 2, 0, 4, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DISABLED_PROTOCOLS_WRITE(v, p)                 FIELD_MWRITE_8((uint8_t *)p + 2, 0, 4, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_READ_G(r, g, idx)                GROUP_MREAD_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 3, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_WRITE_G(v, g, idx)               GROUP_MWRITE_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 3, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_READ(r, p)                       MREAD_8((uint8_t *)p + 3, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_INGRESS_VPORT_WRITE(v, p)                      MWRITE_8((uint8_t *)p + 3, v)
...
#define VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_F_OFFSET              15
#define VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_F_WIDTH               1
#define VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_OFFSET                2
#define VPORT_CFG_ENTRY_FLOW_CONTROL_ALL_TRAFFIC_F_OFFSET_MOD8         7
#define VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_F_OFFSET                14
#define VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_F_WIDTH                 1
#define VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_OFFSET                  2
#define VPORT_CFG_ENTRY_FLOW_CONTROL_BROADCAST_F_OFFSET_MOD8           6
#define VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_F_OFFSET                13
#define VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_F_WIDTH                 1
#define VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_OFFSET                  2
#define VPORT_CFG_ENTRY_FLOW_CONTROL_MULTICAST_F_OFFSET_MOD8           5
#define VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_F_OFFSET               12
#define VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_F_WIDTH                1
#define VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_OFFSET                 2
#define VPORT_CFG_ENTRY_FLOW_CONTROL_UNKNOWN_DA_F_OFFSET_MOD8          4
...
#define VPORT_CFG_EX_ENTRY_INGRESS_FILTER_PROFILE_F_OFFSET                0
...
#define RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_F_OFFSET                          9
#define RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_F_WIDTH                           3
#define RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_OFFSET                            2
#define RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_F_OFFSET_MOD8                     1
...
/* >>>RDD_RULE_BASED_NATC_KEY_ENTRY_DTS */
...
#define RDD_RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_NATC_KEY_ENTRY_DTS) + 2, 1, 3, r)
#define RDD_RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_NATC_KEY_ENTRY_DTS) + 2, 1, 3, v)
#define RDD_RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p + 2, 1, 3, r)
#define RDD_RULE_BASED_NATC_KEY_ENTRY_SUB_TABLE_ID_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p + 2, 1, 3, v)
