...
{
    if(!bbh_queue_descriptor || _entry >= RDD_US_TM_BBH_QUEUE_TABLE_SIZE)
         return BDMF_ERR_PARM;

    RDD_BBH_QUEUE_DESCRIPTOR_SCHEDULER_INDEX_READ_G(bbh_queue_descriptor->scheduler_index, RDD_US_TM_BBH_QUEUE_TABLE_ADDRESS_ARR, _entry);
    RDD_BBH_QUEUE_DESCRIPTOR_SCHEDULER_TYPE_READ_G(bbh_queue_descriptor->scheduler_type, RDD_US_TM_BBH_QUEUE_TABLE_ADDRESS_ARR, _entry);
...
{
    if(!bbh_queue_descriptor || _entry >= RDD_US_TM_BBH_QUEUE_TABLE_SIZE || bbh_queue_descriptor->scheduler_index >= 128)
          return BDMF_ERR_PARM;

    RDD_BBH_QUEUE_DESCRIPTOR_SCHEDULER_INDEX_WRITE_G(bbh_queue_descriptor->scheduler_index, RDD_US_TM_BBH_QUEUE_TABLE_ADDRESS_ARR, _entry);
    RDD_BBH_QUEUE_DESCRIPTOR_SCHEDULER_TYPE_WRITE_G(bbh_queue_descriptor->scheduler_type, RDD_US_TM_BBH_QUEUE_TABLE_ADDRESS_ARR, _entry);
