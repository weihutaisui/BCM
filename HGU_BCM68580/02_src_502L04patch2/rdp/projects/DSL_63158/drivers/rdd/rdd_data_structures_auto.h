...
#define RDD_IPTV_DDR_PORT_BUFFER_ENTRY_HEADER_NUMBER	60

typedef struct
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint8_t	header[RDD_IPTV_DDR_PORT_BUFFER_ENTRY_HEADER_NUMBER];
	uint32_t	context                                                 	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint8_t	header[RDD_IPTV_DDR_PORT_BUFFER_ENTRY_HEADER_NUMBER];
	uint32_t	context                                                 	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#endif
...
#define RDD_IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_IPTV_DDR_PORT_BUFFER_ENTRY_DTS) + 60, r)
#define RDD_IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_IPTV_DDR_PORT_BUFFER_ENTRY_DTS) + 60, v)
#define RDD_IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_READ(r, p)                 MREAD_32((uint8_t *)p + 60, r)
#define RDD_IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_WRITE(v, p)                MWRITE_32((uint8_t *)p + 60, v)
/* <<<RDD_IPTV_DDR_PORT_BUFFER_ENTRY_DTS */
...
/* >>>US_TM_BBH_TX_QUEUE_ID_TABLE */

#define RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_SIZE     2
typedef struct
{
	RDD_BBH_TX_QUEUE_ID_ENTRY_DTS	entry[ RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_DTS;

extern uint32_t RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_PTR(core_id)	( RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_US_TM_BBH_TX_QUEUE_ID_TABLE_ADDRESS_ARR[core_id] ))
...
/* >>>DS_WAN_UDP_FILTER_CONTROL_TABLE */

/* >>>RDD_DS_WAN_UDP_FILTER_CONTROL_ENTRY_DTS */
...
#define RDD_DS_WAN_UDP_FILTER_CONTROL_ENTRY_VALID_MASK_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_CONTROL_ENTRY_DTS), r)
#define RDD_DS_WAN_UDP_FILTER_CONTROL_ENTRY_VALID_MASK_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_CONTROL_ENTRY_DTS), v)
...
typedef struct
{
	RDD_DS_WAN_UDP_FILTER_CONTROL_ENTRY_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DS_WAN_UDP_FILTER_CONTROL_TABLE_DTS;

extern uint32_t RDD_DS_WAN_UDP_FILTER_CONTROL_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DS_WAN_UDP_FILTER_CONTROL_TABLE_PTR(core_id)	( RDD_DS_WAN_UDP_FILTER_CONTROL_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DS_WAN_UDP_FILTER_CONTROL_TABLE_ADDRESS_ARR[core_id] ))
...
/* >>>DS_WAN_UDP_FILTER_TABLE */

/* >>>RDD_DS_WAN_UDP_FILTER_ENTRY_DTS */
...
#define RDD_DS_WAN_UDP_FILTER_ENTRY_OFFSET_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS), r)
#define RDD_DS_WAN_UDP_FILTER_ENTRY_OFFSET_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS), v)
...
#define RDD_DS_WAN_UDP_FILTER_ENTRY_VALUE_READ_G(r, g, idx)           GROUP_MREAD_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS) + 4, r)
#define RDD_DS_WAN_UDP_FILTER_ENTRY_VALUE_WRITE_G(v, g, idx)          GROUP_MWRITE_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS) + 4, v)
...
#define RDD_DS_WAN_UDP_FILTER_ENTRY_MASK_READ_G(r, g, idx)            GROUP_MREAD_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS) + 8, r)
#define RDD_DS_WAN_UDP_FILTER_ENTRY_MASK_WRITE_G(v, g, idx)           GROUP_MWRITE_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS) + 8, v)
...
#define RDD_DS_WAN_UDP_FILTER_ENTRY_HITS_READ_G(r, g, idx)            GROUP_MREAD_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS) + 12, r)
#define RDD_DS_WAN_UDP_FILTER_ENTRY_HITS_WRITE_G(v, g, idx)           GROUP_MWRITE_32(g, idx*sizeof(RDD_DS_WAN_UDP_FILTER_ENTRY_DTS) + 12, v)
...
typedef struct
{
	RDD_DS_WAN_UDP_FILTER_ENTRY_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DS_WAN_UDP_FILTER_TABLE_DTS;

extern uint32_t RDD_DS_WAN_UDP_FILTER_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DS_WAN_UDP_FILTER_TABLE_PTR(core_id)	( RDD_DS_WAN_UDP_FILTER_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DS_WAN_UDP_FILTER_TABLE_ADDRESS_ARR[core_id] ))
...
#define RDD_FPM_POOL_NUMBER_POOL_NUMBER_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FPM_POOL_NUMBER_DTS), 6, 2, r)
#define RDD_FPM_POOL_NUMBER_POOL_NUMBER_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FPM_POOL_NUMBER_DTS), 6, 2, v)
#define RDD_FPM_POOL_NUMBER_POOL_NUMBER_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p, 6, 2, r)
#define RDD_FPM_POOL_NUMBER_POOL_NUMBER_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p, 6, 2, v)
/* <<<RDD_FPM_POOL_NUMBER_DTS */
...
#define RDD_BROADCOM_SWITCH_PORT_TO_RX_FLOW_MAPPING_TABLE_SIZE     8
typedef struct
{
...
#define RDD_TCAM_IC_CFG_TABLE_SIZE     6
typedef struct
{
...
#define RDD_VPORT_TO_LOOKUP_PORT_MAPPING_TABLE_SIZE     8
typedef struct
{
	RDD_BROADCOM_SWITCH_PORT_MAPPING_DTS	entry[ RDD_VPORT_TO_LOOKUP_PORT_MAPPING_TABLE_SIZE ];
}
...
#define RDD_TCAM_IC_CMD_TABLE_SIZE     7
...
#define RDD_FC_FLOW_IP_ADDRESSES_ENTRY_IS_IPV6_ADDRESS_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_FC_FLOW_IP_ADDRESSES_ENTRY_DTS) + 40, r)
#define RDD_FC_FLOW_IP_ADDRESSES_ENTRY_IS_IPV6_ADDRESS_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_FC_FLOW_IP_ADDRESSES_ENTRY_DTS) + 40, v)
...
typedef enum
{
	IMAGE_2_CPU_IF_2_TIMER_INDEX_FIRST           = 2,
...
typedef enum
{
	...
	COUNTER_CPU_GROUP_SPINLOCK_RECYCLE    = 8,
	COUNTER_CPU_GROUP_SHADOW_RECYCLE      = 9,
	COUNTER_CPU_GROUP_LAST                = 9
} rdd_counter_cpu_group;
/* <<<RDD_COUNTER_CPU_GROUP */
...
typedef enum
{
	...
	COUNTER_DROP_DISABLED_QUEUE                     = 80,
	COUNTER_DROP_DISABLED_TX_FLOW                   = 81,
	...
	COUNTER_LAST_NON_DHD                            = 93,
	COUNTER_DHD_RX_DROP_0                           = 94,
	COUNTER_DHD_RX_DROP_1                           = 95,
	COUNTER_DHD_RX_DROP_2                           = 96,
	COUNTER_DHD_TX_FPM_USED_0                       = 97,
	COUNTER_DHD_TX_FPM_USED_1                       = 98,
	COUNTER_DHD_TX_FPM_USED_2                       = 99,
	COUNTER_DHD_TX_DROP_0_SSID_0                    = 100,
	COUNTER_DHD_TX_DROP_1_SSID_0                    = 116,
	COUNTER_DHD_TX_DROP_2_SSID_0                    = 132,
	COUNTER_DHD_TX_FR_FULL_0_AC_0                   = 148,
	COUNTER_DHD_TX_FR_FULL_1_AC_0                   = 152,
	COUNTER_DHD_TX_FR_FULL_2_AC_0                   = 157,
	COUNTER_LAST                                    = 157
} rdd_counter;
/* <<<RDD_COUNTER */
...
{
	QM_QUEUE_FIRST                    = 0,
	QM_QUEUE_SERVICE_QUANTITY         = 0,
	QM_QUEUE_DYNAMIC_EPON             = 0,
	QM_QUEUE_US_DEFAULT_QUANTITY      = 64,
	QM_QUEUE_DS_DEFAULT_QUANTITY      = 64,
	QM_QUEUE_CPU_RX                   = 128,
	QM_QUEUE_MAX_DYNAMIC_QUANTITY     = 128,
...
typedef enum
{
	...
	DISP_REOR_VIQ_CPU_TX_FORWARD    = 15,
	DISP_REOR_VIQ_US_TM_FLUSH       = 16,
	DISP_REOR_VIQ_DS_TM_FLUSH       = 17,
	DISP_REOR_VIQ_TX_MIRRORING      = 18,
...
typedef enum
{
	...
	CLASSIFICATION_RESULT_INDEX_LAST               = 6
} rdd_classification_result_index;
/* <<<RDD_CLASSIFICATION_RESULT_INDEX */
...
#define PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_F_OFFSET                     8
#define PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_F_WIDTH                      1
#define PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_OFFSET                       2
#define PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_F_OFFSET_MOD8                0
...
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 2, 0, 1, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_ENTRY_DTS) + 2, 0, 1, v)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_READ(r, p)                   FIELD_MREAD_8((uint8_t *)p + 2, 0, 1, r)
#define RDD_PACKET_BUFFER_RESOLUTION_ENTRY_RX_MIRRORING_FLAG_WRITE(v, p)                  FIELD_MWRITE_8((uint8_t *)p + 2, 0, 1, v)
...
#define PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_F_OFFSET                24
#define PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_F_WIDTH                 8
#define PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_OFFSET                  4
#define PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_F_OFFSET_MOD16          8

/* >>>RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DTS */
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RESERVED_4_NUMBER	3
...
typedef struct
{
	...
	uint32_t	rule2bridge_resolution                                                     	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = rule2bridge_resolution, size = 8 bits
	...
	uint32_t	ds_resolution                                                              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_READ_G(r, g, idx)        GROUP_MREAD_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DTS) + 4, r)
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_WRITE_G(v, g, idx)       GROUP_MWRITE_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DTS) + 4, v)
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_READ(r, p)               MREAD_8((uint8_t *)p + 4, r)
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_RULE2BRIDGE_RESOLUTION_WRITE(v, p)              MWRITE_8((uint8_t *)p + 4, v)
...
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DS_RESOLUTION_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DTS) + 4, 7, 1, r)
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DS_RESOLUTION_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DTS) + 4, 7, 1, v)
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DS_RESOLUTION_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 4, 7, 1, r)
#define RDD_PACKET_BUFFER_RESOLUTION_UNICAST_ENTRY_DS_RESOLUTION_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 4, 7, 1, v)
...
#define IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_F_OFFSET                              27
#define IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_F_WIDTH                               2
#define IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_OFFSET                                0
#define IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_F_OFFSET_MOD8                         3
#define IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_F_OFFSET_MOD16                        11
#define IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_F_OFFSET                          26
#define IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_F_WIDTH                           1
#define IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_OFFSET                            0
#define IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_F_OFFSET_MOD8                     2
#define IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_F_OFFSET_MOD16                    10
#define IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_F_OFFSET                      21
#define IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_F_WIDTH                       5
#define IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_OFFSET                        0
#define IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_F_OFFSET_MOD8                 5
#define IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_F_OFFSET_MOD16                5
#define IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_F_OFFSET                               20
#define IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_F_WIDTH                                1
#define IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_OFFSET                                 1
#define IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_F_OFFSET_MOD8                          4
#define IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_F_OFFSET_MOD16                         4
#define IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_F_OFFSET                13
#define IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_F_WIDTH                 7
#define IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_OFFSET                  1
#define IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_F_OFFSET_MOD8           5
#define IPTV_PORT_CONTEXT_ENTRY_QUEUE_F_OFFSET                                 5
#define IPTV_PORT_CONTEXT_ENTRY_QUEUE_F_WIDTH                                  8
#define IPTV_PORT_CONTEXT_ENTRY_QUEUE_OFFSET                                   2
...
#define RDD_IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS), 3, 2, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS), 3, 2, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p, 3, 2, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_LAG_PORT_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p, 3, 2, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS), 2, 1, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS), 2, 1, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_READ(r, p)                           FIELD_MREAD_8((uint8_t *)p, 2, 1, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_IS_HIGH_PRIO_WRITE(v, p)                          FIELD_MWRITE_8((uint8_t *)p, 2, 1, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_READ_G(r, g, idx)                GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS), 5, 5, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS), 5, 5, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_READ(r, p)                       FIELD_MREAD_16((uint8_t *)p, 5, 5, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_HEADER_LENGTH_WRITE(v, p)                      FIELD_MWRITE_16((uint8_t *)p, 5, 5, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS) + 1, 4, 1, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS) + 1, 4, 1, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_READ(r, p)                                FIELD_MREAD_8((uint8_t *)p + 1, 4, 1, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_PUSH_WRITE(v, p)                               FIELD_MWRITE_8((uint8_t *)p + 1, 4, 1, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_READ_G(r, g, idx)          GROUP_FIELD_MREAD_32(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS) + 0, 13, 7, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_32(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS) + 0, 13, 7, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_READ(r, p)                 FIELD_MREAD_32((uint8_t *)p + 0, 13, 7, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_L2_COMMAND_LIST_LENGTH_WRITE(v, p)                FIELD_MWRITE_32((uint8_t *)p + 0, 13, 7, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_QUEUE_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS) + 2, 5, 8, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_QUEUE_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_IPTV_PORT_CONTEXT_ENTRY_DTS) + 2, 5, 8, v)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_QUEUE_READ(r, p)                                  FIELD_MREAD_16((uint8_t *)p + 2, 5, 8, r)
#define RDD_IPTV_PORT_CONTEXT_ENTRY_QUEUE_WRITE(v, p)                                 FIELD_MWRITE_16((uint8_t *)p + 2, 5, 8, v)
...
#define IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_F_OFFSET                               0
#define IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_F_WIDTH                                32
#define IPTV_DDR_PORT_BUFFER_ENTRY_CONTEXT_OFFSET                                 60
/* <<<RDD_IPTV_DDR_PORT_BUFFER_ENTRY */
...
#define FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_F_OFFSET                                   15
#define FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_F_WIDTH                                    1
#define FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_OFFSET                                     6
#define FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_F_OFFSET_MOD8                              7
...
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_F_OFFSET                          7
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_F_WIDTH                           1
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_OFFSET                            7
...
#define FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_F_OFFSET                      0
#define FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_F_WIDTH                       5
#define FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_OFFSET                        7
...
#define FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_F_OFFSET                            21
#define FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_F_WIDTH                             2
#define FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_OFFSET                              9
#define FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_F_OFFSET_MOD8                       5
#define FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_F_OFFSET_MOD16                      5
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_F_OFFSET              18
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_F_WIDTH               3
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_OFFSET                9
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_F_OFFSET_MOD8         2
#define FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_F_OFFSET_MOD16        2
...
#define FC_UCAST_FLOW_CONTEXT_ENTRY_COMMAND_LIST_OFFSET                            12
...
typedef struct
{
	...
	uint32_t	tos                                                                   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	drop                                                                  	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	valid                                                                 	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_READ_G(r, g, idx)                               GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 6, 7, 1, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_WRITE_G(v, g, idx)                              GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 6, 7, 1, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_READ(r, p)                                      FIELD_MREAD_8((uint8_t *)p + 6, 7, 1, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_TOS_WRITE(v, p)                                     FIELD_MWRITE_8((uint8_t *)p + 6, 7, 1, v)
...
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 7, 7, 1, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 7, 7, 1, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_READ(r, p)                             FIELD_MREAD_8((uint8_t *)p + 7, 7, 1, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IS_HIGH_PRIO_WRITE(v, p)                            FIELD_MWRITE_8((uint8_t *)p + 7, 7, 1, v)
...
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 7, 0, 5, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 7, 0, 5, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 7, 0, 5, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_SERVICE_QUEUE_ID_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 7, 0, 5, v)
...
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 9, 5, 2, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 9, 5, 2, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 9, 5, 2, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_EGRESS_PHY_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 9, 5, 2, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 9, 2, 3, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 9, 2, 3, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p + 9, 2, 3, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_IP_ADDRESSES_TABLE_INDEX_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p + 9, 2, 3, v)
...
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_COMMAND_LIST_READ_G(r, g, idx, i)                   GROUP_MREAD_I_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 12, i, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_COMMAND_LIST_WRITE_G(v, g, idx, i)                  GROUP_MWRITE_I_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS) + 12, i, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_COMMAND_LIST_READ(r, p, i)                          MREAD_I_8((uint8_t *)p + 12, i, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_COMMAND_LIST_WRITE(v, p, i)                         MWRITE_I_8((uint8_t *)p + 12, i, v)
/* <<<RDD_FC_UCAST_FLOW_CONTEXT_ENTRY_DTS */
...
#define FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_CHAIN_IDX_F_WIDTH                              8
#define FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_CHAIN_IDX_OFFSET                               11
...
#define RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_CHAIN_IDX_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_DTS) + 11, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_CHAIN_IDX_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_DTS) + 11, v)
#define RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_CHAIN_IDX_READ(r, p)                 MREAD_8((uint8_t *)p + 11, r)
#define RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_CHAIN_IDX_WRITE(v, p)                MWRITE_8((uint8_t *)p + 11, v)
/* <<<RDD_FC_UCAST_FLOW_CONTEXT_WFD_NIC_ENTRY_DTS */
...
#define RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_F_OFFSET            26
#define RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_F_WIDTH             1
#define RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_OFFSET              0
#define RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_F_OFFSET_MOD8       2
#define RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_F_OFFSET_MOD16      10
...
typedef struct
{
	...
	uint32_t	vlan_action              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	dei_or_iptv_common_actions	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = dei_or_iptv_common_actions, size = 1 bits
...
#define RDD_RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_READ_G(r, g, idx)         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS), 2, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_WRITE_G(v, g, idx)        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS), 2, 1, v)
#define RDD_RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_READ(r, p)                FIELD_MREAD_8((uint8_t *)p, 2, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_DEI_OR_IPTV_COMMON_ACTIONS_WRITE(v, p)               FIELD_MWRITE_8((uint8_t *)p, 2, 1, v)
...
#define RDD_RULE_BASED_CONTEXT_ENTRY_IPTV_COMMON_ACTIONS_EXIT_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS), 2, 1, r)
#define RDD_RULE_BASED_CONTEXT_ENTRY_IPTV_COMMON_ACTIONS_EXIT_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_RULE_BASED_CONTEXT_ENTRY_DTS), 2, 1, v)
...
#define VPORT_CFG_ENTRY_BRIDGE_AND_VLAN_LOOKUP_METHOD_F_OFFSET         25
...
typedef struct
{
	...
	uint8_t	protocol   	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	lookup_port	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint8_t	lookup_port	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	protocol   	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint8_t	reserved   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_TUPLE_PROTO_DTS;

#define RDD_TUPLE_PROTO_PROTOCOL_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_TUPLE_PROTO_DTS), 4, 3, r)
#define RDD_TUPLE_PROTO_PROTOCOL_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_TUPLE_PROTO_DTS), 4, 3, v)
#define RDD_TUPLE_PROTO_PROTOCOL_READ(r, p)                    FIELD_MREAD_8((uint8_t *)p, 4, 3, r)
#define RDD_TUPLE_PROTO_PROTOCOL_WRITE(v, p)                   FIELD_MWRITE_8((uint8_t *)p, 4, 3, v)
#define RDD_TUPLE_PROTO_LOOKUP_PORT_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_TUPLE_PROTO_DTS), 0, 4, r)
#define RDD_TUPLE_PROTO_LOOKUP_PORT_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_TUPLE_PROTO_DTS), 0, 4, v)
#define RDD_TUPLE_PROTO_LOOKUP_PORT_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p, 0, 4, r)
#define RDD_TUPLE_PROTO_LOOKUP_PORT_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p, 0, 4, v)
/* <<<RDD_TUPLE_PROTO_DTS */
...
#define NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_F_OFFSET                         22
#define NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_F_WIDTH                          9
#define NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_OFFSET                           0
#define NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_F_OFFSET_MOD16                   6
#define NAT_CACHE_LKP_ENTRY_VPORT_F_OFFSET                                 16
#define NAT_CACHE_LKP_ENTRY_VPORT_F_WIDTH                                  6
#define NAT_CACHE_LKP_ENTRY_VPORT_OFFSET                                   1
#define NAT_CACHE_LKP_ENTRY_VPORT_F_OFFSET_MOD8                            0
#define NAT_CACHE_LKP_ENTRY_VPORT_F_OFFSET_MOD16                           0
#define NAT_CACHE_LKP_ENTRY_DST_IP_3_0_F_OFFSET                            12
#define NAT_CACHE_LKP_ENTRY_DST_IP_3_0_F_WIDTH                             4
#define NAT_CACHE_LKP_ENTRY_DST_IP_3_0_OFFSET                              2
#define NAT_CACHE_LKP_ENTRY_DST_IP_3_0_F_OFFSET_MOD8                       4
#define NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_F_OFFSET                          9
#define NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_F_WIDTH                           3
#define NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_OFFSET                            2
#define NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_F_OFFSET_MOD8                     1
#define NAT_CACHE_LKP_ENTRY_KEY_EXTEND_F_OFFSET                            8
#define NAT_CACHE_LKP_ENTRY_KEY_EXTEND_F_WIDTH                             1
...
#define RDD_NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_READ_G(r, g, idx)          GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS), 6, 9, r)
#define RDD_NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS), 6, 9, v)
#define RDD_NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_READ(r, p)                 FIELD_MREAD_16((uint8_t *)p, 6, 9, r)
#define RDD_NAT_CACHE_LKP_ENTRY_ZERO_RESERVED_WRITE(v, p)                FIELD_MWRITE_16((uint8_t *)p, 6, 9, v)
#define RDD_NAT_CACHE_LKP_ENTRY_VPORT_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 1, 0, 6, r)
#define RDD_NAT_CACHE_LKP_ENTRY_VPORT_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 1, 0, 6, v)
#define RDD_NAT_CACHE_LKP_ENTRY_VPORT_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 1, 0, 6, r)
#define RDD_NAT_CACHE_LKP_ENTRY_VPORT_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 1, 0, 6, v)
#define RDD_NAT_CACHE_LKP_ENTRY_DST_IP_3_0_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 2, 4, 4, r)
#define RDD_NAT_CACHE_LKP_ENTRY_DST_IP_3_0_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 2, 4, 4, v)
#define RDD_NAT_CACHE_LKP_ENTRY_DST_IP_3_0_READ(r, p)                    FIELD_MREAD_8((uint8_t *)p + 2, 4, 4, r)
#define RDD_NAT_CACHE_LKP_ENTRY_DST_IP_3_0_WRITE(v, p)                   FIELD_MWRITE_8((uint8_t *)p + 2, 4, 4, v)
#define RDD_NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 2, 1, 3, r)
#define RDD_NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 2, 1, 3, v)
#define RDD_NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_READ(r, p)                  FIELD_MREAD_8((uint8_t *)p + 2, 1, 3, r)
#define RDD_NAT_CACHE_LKP_ENTRY_SUB_TABLE_ID_WRITE(v, p)                 FIELD_MWRITE_8((uint8_t *)p + 2, 1, 3, v)
#define RDD_NAT_CACHE_LKP_ENTRY_KEY_EXTEND_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 2, 0, 1, r)
#define RDD_NAT_CACHE_LKP_ENTRY_KEY_EXTEND_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_NAT_CACHE_LKP_ENTRY_DTS) + 2, 0, 1, v)
#define RDD_NAT_CACHE_LKP_ENTRY_KEY_EXTEND_READ(r, p)                    FIELD_MREAD_8((uint8_t *)p + 2, 0, 1, r)
#define RDD_NAT_CACHE_LKP_ENTRY_KEY_EXTEND_WRITE(v, p)                   FIELD_MWRITE_8((uint8_t *)p + 2, 0, 1, v)
