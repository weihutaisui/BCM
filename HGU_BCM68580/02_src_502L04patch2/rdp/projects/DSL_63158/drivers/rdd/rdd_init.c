...
rdd_vport_id_t rx_flow_to_vport[RX_FLOW_CONTEXTS_NUMBER] = {
    ...
    [RDD_NUM_OF_WAN_FLOWS + BB_ID_RX_PON] = RDD_LAN3_VPORT,
    [RDD_NUM_OF_WAN_FLOWS + BB_ID_RX_10G] = RDD_LAN4_VPORT,
    [RDD_NUM_OF_WAN_FLOWS + BB_ID_RX_2P5] = RDD_LAN5_VPORT,
    [RDD_NUM_OF_WAN_FLOWS + BB_ID_RX_DSL] = RDD_LAN6_VPORT,
...
static uint8_t g_lookup_port_init_mapping_table[16];
...
static void image_3_context_set(uint32_t core_index)
{
    ...
    local_regs[IMAGE_3_US_TM_WAN_THREAD_NUMBER][reg_id[11]] = BB_ID_TX_PON | (IMAGE_3_COMPLEX_SCHEDULER_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_3_US_TM_WAN_THREAD_NUMBER][reg_id[9]]  = IMAGE_3_US_TM_SCHEDULING_QUEUE_TABLE_ADDRESS << 16; 
    ...
    /* REPORTING : thread 10 */
    local_regs[IMAGE_3_US_TM_REPORTING_THREAD_NUMBER][reg_id[18]] = drv_qm_get_us_end();
    ...
    local_regs[IMAGE_3_US_TM_REPORTING_THREAD_NUMBER][reg_id[14]] = BB_ID_TX_PON_STAT;
