...
public:
    ...
    BCMXTM_STATUS SetLinkInfo( UINT32 ulLinkMask, PXTM_INTERFACE_LINK_INFO pLinkInfo,
                               UINT32 ulBondingPort, PXTM_INTERFACE_LINK_INFO pOtherLinkInfo, UINT32 ulxDSLMode);
 ...
 */
#define XTM_MAJ_VER           16
#define XTM_MIN_VER           4
...
#else
#define XTM_IS_WRCHAN_FLUSH_BUSY  0
#endif
