...
int pmd_op_file(pmd_dev_client client, unsigned char * buf, int len, bool read_op)
{
    ...
    case pmd_iram_map:
        ...
        break;
    case pmd_cal_map:
        fp = filp_open(PMD_CALIBRATION_FILE_PATH, flags, mode);
        break;
    case pmd_temp2apd_map:
        fp = filp_open(PMD_TEMP2APD_FILE_PATH, flags, mode);
        break;
...
int pmd_op_get_file_len(pmd_dev_client client, uint16_t * len)
{
    ...
    case pmd_iram_map:
        ...
        break;
    case pmd_cal_map:
        file = PMD_CALIBRATION_FILE_PATH;
        break;
    case pmd_temp2apd_map:
        file = PMD_TEMP2APD_FILE_PATH;
        break;
    default:
...
int pmd_temp2apd_file_op(uint16_t* p_pmd_temp_apd_conv)
{
    ...
    else
    {
        ...
        {
            *(p_pmd_temp_apd_conv+i) = swab16(*(p_pmd_temp_apd_conv+i));
        }
#endif
