...
/******************************************************************************
 * Field: GPON_RX_AMD2_TOD_ARM_ARM
 ******************************************************************************/
const ru_field_rec GPON_RX_AMD2_TOD_ARM_ARM_FIELD =
{
    "ARM",
#if RU_INCLUDE_DESC
    "arm",
...
#endif
    GPON_RX_AMD2_TOD_ARM_ARM_FIELD_MASK,
    0,
    GPON_RX_AMD2_TOD_ARM_ARM_FIELD_WIDTH,
    GPON_RX_AMD2_TOD_ARM_ARM_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: GPON_RX_AMD2_TOD_ARM_EN
 ******************************************************************************/
const ru_field_rec GPON_RX_AMD2_TOD_ARM_EN_FIELD =
{
    "EN",
#if RU_INCLUDE_DESC
    "update_en",
    "Enables the update of the TOD.",
#endif
    GPON_RX_AMD2_TOD_ARM_EN_FIELD_MASK,
    0,
    GPON_RX_AMD2_TOD_ARM_EN_FIELD_WIDTH,
    GPON_RX_AMD2_TOD_ARM_EN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: GPON_RX_AMD2_TOD_ARM_RESERVED0
 ******************************************************************************/
const ru_field_rec GPON_RX_AMD2_TOD_ARM_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    GPON_RX_AMD2_TOD_ARM_RESERVED0_FIELD_MASK,
    0,
    GPON_RX_AMD2_TOD_ARM_RESERVED0_FIELD_WIDTH,
    GPON_RX_AMD2_TOD_ARM_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Register: GPON_RX_AMD2_TOD_ARM
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *GPON_RX_AMD2_TOD_ARM_FIELDS[] =
{
    &GPON_RX_AMD2_TOD_ARM_ARM_FIELD,
    &GPON_RX_AMD2_TOD_ARM_EN_FIELD,
    &GPON_RX_AMD2_TOD_ARM_RESERVED0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec GPON_RX_AMD2_TOD_ARM_REG = 
{
    "TOD_ARM",
#if RU_INCLUDE_DESC
...
#endif
    GPON_RX_AMD2_TOD_ARM_REG_OFFSET,
    0,
    0,
    114,
#if RU_INCLUDE_ACCESS
...
/* End of file BCM6858_A0GPON_RX_AMD2.c */
