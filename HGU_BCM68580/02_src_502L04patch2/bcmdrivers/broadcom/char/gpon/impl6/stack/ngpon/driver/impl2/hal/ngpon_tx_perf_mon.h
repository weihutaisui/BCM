...
#ifndef _BCM6858_NGPON_TX_PERF_MON_AG_H_
#define _BCM6858_NGPON_TX_PERF_MON_AG_H_
...
#ifdef USE_BDMF_SHELL
bdmfmon_handle_t ag_drv_ngpon_tx_perf_mon_cli_init(bdmfmon_handle_t driver_dir);
#endif
