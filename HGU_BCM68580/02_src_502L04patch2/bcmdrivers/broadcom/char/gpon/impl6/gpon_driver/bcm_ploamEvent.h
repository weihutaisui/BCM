...
* :>
*/ 
#ifndef BCM_PLOAM_EVENT_H
#define BCM_PLOAM_EVENT_H

#include "bcm_OS_Deps.h"
#include "bcm_gponBasicDefs.h"

typedef void (BCM_PloamEventCallback)(IN void *arg);

typedef struct {
  BCM_PloamEventCallback *callback;
  void *ctxt;
