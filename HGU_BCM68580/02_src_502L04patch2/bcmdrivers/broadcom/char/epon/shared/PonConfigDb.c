...
#include "EponUser.h"
#include "board.h"
#if !defined(CONFIG_BCM96848)  /* TODO!!  remove once OPTICALDET supports for 6848 */
...
static WanRateMode wanRateMode;
...
////////////////////////////////////////////////////////////////////////////////
/// \brief Return whether wan rate is assigned in psp
///
/// \param
/// None
///
...
////////////////////////////////////////////////////////////////////////////////
//extern
BOOL PonCfgDbGetWanRateMode (void)
    {
    return wanRateMode;
    } // PonCfgDbGetUpRate
...
static Polarity PonTxPolarity (U8  ponIf)
    {
    ...
    if (0 == trx_get_lbe_polarity(bus, &lbe_polarity))
        ...
        {
        return (Polarity)GetEponDefTxPolarity(ponIf);
        }
#else /* CONFIG_BCM96848,  TODO!!  remove once OPTICALDET supports for 6848 */
    return (Polarity)GetEponDefTxPolarity(ponIf);
#endif        
    }
...
void ReadPonDefCfg (void)
    ...
    for (ponIf = 0; ponIf < NumPonIf; ponIf++)
        ...
        if (ponCfg.pon[ponIf].available)
            ...
            ponCfg.pon[ponIf].txPolarity = PonTxPolarity(ponIf);
            ...
            if(ponCfg.pon[ponIf].upRate == LaserRate10G)
                ponCfg.pon[ponIf].maxFrameSize = EponMaxFrameSize10G;
#endif           
