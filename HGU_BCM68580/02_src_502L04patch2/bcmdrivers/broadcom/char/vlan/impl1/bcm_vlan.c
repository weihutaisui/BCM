...
#ifdef CC_DROP_PRECEDENCE
extern void bcmenet_register_dp_cb(UBOOL8 (*BCMENET_DP_LOOKUP_CB)(
  struct net_device *dev, uint8 *data, unsigned int len));
...
#ifdef CC_DROP_PRECEDENCE
    bcmenet_register_dp_cb(bcmVlan_lookupDp);
#endif /* CC_DROP_PRECEDENCE */
