...
/******************************************************************************
 * Field: MISC_0_RESERVED1
 ******************************************************************************/
const ru_field_rec MISC_0_RESERVED1_FIELD =
{
    "RESERVED1",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    MISC_0_RESERVED1_FIELD_MASK,
    0,
    MISC_0_RESERVED1_FIELD_WIDTH,
    MISC_0_RESERVED1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_3_CFG_NTR_PULSE_WIDTH
 ******************************************************************************/
const ru_field_rec MISC_3_CFG_NTR_PULSE_WIDTH_FIELD =
{
    "CFG_NTR_PULSE_WIDTH",
#if RU_INCLUDE_DESC
    "",
...
#endif
    MISC_3_CFG_NTR_PULSE_WIDTH_FIELD_MASK,
    0,
    MISC_3_CFG_NTR_PULSE_WIDTH_FIELD_WIDTH,
    MISC_3_CFG_NTR_PULSE_WIDTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
{
    &MISC_3_CFG_NTR_PULSE_WIDTH_FIELD,
