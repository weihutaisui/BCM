...
int ag_drv_misc_misc_3_set(const misc_misc_3 *misc_3)
{
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, CFG_NTR_PULSE_WIDTH, reg_3, misc_3->cfg_ntr_pulse_width);
...
int ag_drv_misc_misc_3_get(misc_misc_3 *misc_3)
{
    ...
    misc_3->cfg_ntr_pulse_width = RU_FIELD_GET(0, MISC, 3, CFG_NTR_PULSE_WIDTH, reg_3);
