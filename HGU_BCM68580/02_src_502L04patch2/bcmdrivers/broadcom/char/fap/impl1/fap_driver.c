...
void fapIq_set_proto_prio( uint8_t protoType, uint8_t protoval, 
            uint8_t prio );
void fapIq_rem_proto_prio( uint8_t protoType, uint8_t protoval); 
...
int __init fapDrv_construct(void)
{
    ...
    iqos_fap_set_proto_prio_hook_g = fapIq_set_proto_prio;
    iqos_fap_rem_proto_prio_hook_g = fapIq_rem_proto_prio;
#if defined(CONFIG_BCM_XTMCFG) || defined(CONFIG_BCM_XTMCFG_MODULE)
...
void __exit fapDrv_destruct(void)
{
    ...
    iqos_fap_set_proto_prio_hook_g = NULL;
    iqos_fap_rem_proto_prio_hook_g = NULL;
#if defined(CONFIG_BCM_XTMCFG) || defined(CONFIG_BCM_XTMCFG_MODULE)
