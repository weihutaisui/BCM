...
Public void * AdslCoreFrameAllocMemForFrames(UINT32 frameNum)
{
	void	**pFreeFrameList;
	uchar	*frPtr;
	UINT32	i;
...
Public void * AdslCoreFrameAllocMemForBuffers(void **ppMemPool, UINT32 bufNum, UINT32 memSize)
{
	void	**pFreeBufList;
	uchar	*frPtr;
	UINT32	i;
...
Public void AdslCoreFrameFreeMemForBuffers(void *hMem, UINT32 memSize, void *pMemPool)
{
	free (pMemPool);
}

Public dslFrameBuffer * AdslCoreFrameAllocBuffer(void *handle, void *pMem, UINT32 length)
{
	dslFrameBuffer	*pBuf;
...
Public UINT32 AdslCoreFrame2Id(void *handle, dslFrame *pFrame)
{
	return ((uchar *)pFrame - (uchar *)handle - sizeof (void *)) / sizeof(dslFrame);
}

Public void * AdslCoreFrameId2Frame(void *handle, UINT32 frameId)
{
