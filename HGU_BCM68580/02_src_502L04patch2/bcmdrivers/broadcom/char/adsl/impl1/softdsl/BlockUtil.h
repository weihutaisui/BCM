...
extern	void	BlockLongAdd				(int, INT32*, INT32*, INT32*);
extern	void	BlockLong2ShortSubtract		(int, INT32*, INT32*, short*);
extern	void	BlockShort2LongMove			(int, short*, INT32*);
...
extern	INT32	BlockShortInterpolateWithIncrement (int size, INT32 scaleFactor, INT32 increment, int shift, short* src1Ptr, short* src2Ptr, short* dstPtr);
...
extern	INT32	BlockSum					(int, short*);
extern	INT32	BlockByteSum				(int, uchar*);
extern	void	BlockComplexSum				(int, ComplexShort*, ComplexLong*);
extern	void	BlockComplexPower			(int, int, ComplexShort*, INT32*);
extern	INT32	BlockFullPower				(int, short*);
extern	INT32	BlockLongCorrelate			(int, INT32*, INT32*);
...
extern	void	BlockLongMove				(int, INT32*, INT32*);
...
extern	INT32	BlockPower					(int, short*);
...
extern	INT32	BlockCorrelate				(int, short*, short*);
...
extern	void	BlockComplexLongFill		(int, INT32, INT32, ComplexLong*);

extern	void	BlockShortSubtract			(int, short*, short*, short*);
extern	void	BlockLongSubtract			(int, INT32*, INT32*, INT32*);
...
extern	void	BlockLongFill				(int, INT32, INT32*);
extern	void	BlockLongClear				(int, INT32*);
