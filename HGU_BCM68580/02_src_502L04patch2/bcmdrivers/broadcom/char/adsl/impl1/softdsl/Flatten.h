...
#define	kMaxFlattenFramelength		(kMaxFlattenedStatusSize - (4*sizeof(INT32)) - 20)

extern int	SM_DECL FlattenCommand	(dslCommandStruct *cmd, UINT32 *dstPtr, UINT32 nAvail);
extern int	SM_DECL UnflattenCommand(UINT32 *srcPtr, dslCommandStruct *cmd);
extern int	SM_DECL FlattenStatus	(dslStatusStruct *status, UINT32 *dstPtr, UINT32 nAvail);
extern int	SM_DECL UnflattenStatus	(UINT32 *srcPtr, dslStatusStruct *status);
