...
typedef struct {
	UINT32	sdramPageAddr0;		/* Place holder for backward compatibility with DslDiags */
	UINT32	sdramImageAddr0;
	UINT32	sdramImageSize;
...
#elif defined(CONFIG_BCM963138) || defined(CONFIG_BCM963381) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963158)
...
#define ADSL_MIPS_LMEM_ADDR(a)			(((UINT32)(a) & DSL_PHY_LMEM_BASE) == DSL_PHY_LMEM_BASE)
#define ADSL_MIPS_SDRAM_ADDR(a)			(((UINT32)(a) & DSL_PHY_SDRAM_ADDR_MASK) == DSL_PHY_SDRAM_BASE)
#if !defined(CONFIG_ARM) && !defined(CONFIG_ARM64)
#define	SDRAM_ADDR_TO_HOST(a)			((void *) ((UINT32)(a) - adslCorePhyDesc.sdramPhyImageAddr + \
										(ADSLXF->sdramBaseAddr ? (uintptr_t) ADSLXF->sdramBaseAddr : (uintptr_t)ADSL_SDRAM_HOST_ADDR_DEFAULT)))
#else
#define	SDRAM_ADDR_TO_HOST(a)			((void *) ((uintptr_t)((UINT32)(a) - adslCorePhyDesc.sdramPhyImageAddr) + \
...
#define LMEM_ADDR_TO_HOST(a)			((void *)((uintptr_t)((UINT32) (a) + (HOST_LMEM_BASE - ((UINT32)(a) & 0xff000000)))))
#else
#define HOST_XMEM_BASE				DSLXMEM_BASE
#define DSL_PHY_XMEM_BASE			0x191A0000
#define LMEM_ADDR_TO_HOST1(a)			((void *)((uintptr_t)((UINT32) (a) + (HOST_LMEM_BASE - ((UINT32)(a) & 0xff000000)))))
#define XMEM_ADDR_TO_HOST(a)			((void *)((uintptr_t)( HOST_XMEM_BASE + (((UINT32)(a)&0x1FFFFFFF) - DSL_PHY_XMEM_BASE))))
#define LMEM_ADDR_TO_HOST(a)			((((UINT32)(a) & 0x1FFFFFFF) < DSL_PHY_XMEM_BASE)? LMEM_ADDR_TO_HOST1(a): XMEM_ADDR_TO_HOST(a))
#endif
#if defined(_NOOS)
#define SDRAM_ADDR_TO_ADSL(a)			(((uintptr_t)(a)) | 0xA0000000)
#elif defined(CONFIG_ARM) || defined(CONFIG_ARM64)
#define SDRAM_ADDR_TO_ADSL(a)			(virt_to_phys((void *)(uintptr_t)(a)) | 0xA0000000)
#else
...
#ifndef DEBUG
#ifndef CONFIG_BCM963158	/* TONY - Excluded for 63158 due to "uint32 DEBUG[2]" in 63158_map_part.h causes build error */
#define DEBUG	0
#endif
#endif
