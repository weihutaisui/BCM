...
extern INT32		SM_DECL	GetRateValue(dataRateMap rate);
extern int 		SM_DECL	DecToString(UINT32 value, uchar *dstPtr, uint nDigits);
extern int 		SM_DECL	HexToString(UINT32 value, uchar *dstPtr, uint nDigits);
extern char *	SM_DECL	DecToStr(char *s, UINT32 num);
extern char *	SM_DECL	SignedToStr(char *s, INT32 num);
extern char *	SM_DECL	HexToStr(char *s, UINT32 num);
