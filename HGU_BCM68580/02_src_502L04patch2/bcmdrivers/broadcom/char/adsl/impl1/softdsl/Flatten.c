...
Public int FlattenCommand (dslCommandStruct *cmd, UINT32 *dstPtr, UINT32 nAvail)
{
#define	CHECK_CMD_BUF_AVAIL(szReq,szAvail)	if ((INT32)(szReq) > (INT32)(szAvail)) return 0;

	UINT32	*dstPtr0  = dstPtr;
	UINT32	statAvail = (nAvail >> 2);

	*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->command);
	switch (DSL_COMMAND_CODE(cmd->command)) {
...
#endif
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.direction);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.modulations);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.minDataRate);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.maxDataRate);
#if	defined(G992P2) || (defined(G992P1_ANNEX_A) && defined(G992P1_ANNEX_A_USED_FOR_G992P2))
			if (ADSL_PHY_SUPPORT(kAdslPhyG992p2Init)) {
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p2.downstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p2.downstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p2.upstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p2.upstreamMaxCarr);
			}
#endif
#ifdef	G992P1_ANNEX_A
			if (ADSL_PHY_SUPPORT(kAdslPhyAnnexA)) {
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1.downstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1.downstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1.upstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1.upstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.subChannelInfo);
			}
#endif
#ifdef	G992P1_ANNEX_B
			if (ADSL_PHY_SUPPORT(kAdslPhyAnnexB) || ADSL_PHY_SUPPORT(kAdslPhySADSL)) {
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexB.downstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexB.downstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexB.upstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexB.upstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.subChannelInfoAnnexB);
			}
#endif
#ifdef	G992_ANNEXC
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexC.downstreamMinCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexC.downstreamMaxCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexC.upstreamMinCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexC.upstreamMaxCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.subChannelInfoAnnexC);
#endif
#ifdef	G992P1_ANNEX_I
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexI.downstreamMinCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexI.downstreamMaxCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexI.upstreamMinCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p1AnnexI.upstreamMaxCarr);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.subChannelInfoAnnexI);
#endif
#ifdef	G992P5
			if (ADSL_PHY_SUPPORT(kAdslPhyAdsl2p)) {
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p5.downstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p5.downstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p5.upstreamMinCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p5.upstreamMaxCarr);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.subChannelInfop5);
			}
#endif
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.features);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.auxFeatures);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.demodCapabilities);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.noiseMargin);
#ifdef G992_ATUC /* last please, for ATU-C only */
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.xmtRSf);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.xmtRS);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.xmtS);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.xmtD);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.rcvRSf);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.rcvRS);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.rcvS);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.rcvD);
#endif
#ifdef G992P3
			if (ADSL_PHY_SUPPORT(kAdslPhyAdsl2)) {
#ifdef FLATTEN_ADDR_ADJUST
				*dstPtr++ = (UINT32) (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslModeSpec.capabilities.carrierInfoG992p3AnnexA)));
#else
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p3AnnexA);
#endif
			}
#endif
#ifdef G992P5
			if (ADSL_PHY_SUPPORT(kAdslPhyAdsl2p)) {
#ifdef FLATTEN_ADDR_ADJUST
				*dstPtr++ = (UINT32) (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslModeSpec.capabilities.carrierInfoG992p5AnnexA)));
#else
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG992p5AnnexA);
#endif
			}
#endif
#ifdef G993
...
#ifdef FLATTEN_ADDR_ADJUST
				*dstPtr++ = (UINT32) (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslModeSpec.capabilities.carrierInfoG993p2AnnexA)));
#else
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslModeSpec.capabilities.carrierInfoG993p2AnnexA);
#endif
			}
#endif
			break;
		...
		case kDslDiagSetupCmd:
			...
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslDiagSpec.setup);
		...
		case kDslTestCmd:
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.type);
			if (kDslTestToneSelection == cmd->param.dslTestSpec.type) {
				...
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.param.toneSelectSpec.xmtStartTone);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.param.toneSelectSpec.xmtNumOfTones);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.param.toneSelectSpec.rcvStartTone);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.param.toneSelectSpec.rcvNumOfTones);
				...
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslTestSpec.param.value);
			}
				...
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.param.marginTweakSpec.extraPowerRequestQ4dB);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslTestSpec.param.marginTweakSpec.numOfCarriers);
...
#else
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslStatusBufSpec.pBuf);
#endif
...
#ifdef FLATTEN_ADDR_ADJUST
			*dstPtr++ = (UINT32) (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslAfeTestSpec.afeParamPtr)));
#else
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslAfeTestSpec.afeParamPtr);
#endif
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32(cmd->param.dslAfeTestSpec.afeParamSize);
#ifdef FLATTEN_ADDR_ADJUST
			*dstPtr++ = (UINT32) (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslAfeTestSpec.imagePtr)));
#else
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslAfeTestSpec.imagePtr);
#endif
...
#else
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inpBinPtr);
#endif
			}
...
#else
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.itaBinPtr);
#endif
			}
			else if (kDslINMControlParams==cmd->param.dslPlnSpec.plnCmd) {
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmContinueConfig);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmInpEqMode);
			}
			else if (kDslINMConfigParams==cmd->param.dslPlnSpec.plnCmd) {
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmContinueConfig);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmInpEqMode);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmIATO);
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmIATS);
			}
			else if (kDslINMConfigInpEqFormat == cmd->param.dslPlnSpec.plnCmd)
				*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32) cmd->param.dslPlnSpec.inmInpEqFormat);
			break;

#ifdef G997_1
		case kDslSendEocCommand:
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.value);
...
#ifdef FLATTEN_ADDR_ADJUST
					*dstPtr++ = (UINT32)  (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslClearEocMsg.dataPtr)));
#else
					*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslClearEocMsg.dataPtr);
#endif
				}
			break;
#endif
		...
		case kDslOLRRequestCmd:
			...
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslOLRRequest.msgType);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslOLRRequest.nCarrs);
			...
			dstPtr += 1;
#ifdef FLATTEN_ADDR_ADJUST
			*dstPtr++ = (UINT32) (ADSL_ENDIAN_CONV_INT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslOLRRequest.carrParamPtr)));
#else
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslOLRRequest.carrParamPtr);
#endif
			break;

		case kDslPwrMgrCmd:
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32(cmd->param.dslPwrMsg.msgType);
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslPwrMsg.param.msg.msgLen);
#ifdef FLATTEN_ADDR_ADJUST
			*dstPtr++ = ADSL_ENDIAN_CONV_UINT32(SDRAM_ADDR_TO_ADSL(cmd->param.dslPwrMsg.param.msg.msgData));
#else
			*dstPtr++ = ADSL_ENDIAN_CONV_INT32((UINT32)cmd->param.dslPwrMsg.param.msg.msgData);
#endif
			break;
#endif
...
Public int UnflattenCommand(UINT32 *srcPtr, dslCommandStruct *cmd)
{
	UINT32	*srcPtr0 = srcPtr;
...
Private void * FlattenStatusSlow (dslStatusStruct *status, UINT32 *dstPtr, UINT32 statAvail, UINT32 *dstPtr0)
{
#define	CHECK_BUF_AVAIL_SLOW(szReq,szAvail)	if ((INT32)(szReq) > (INT32)(szAvail)) return dstPtr0;
	...
	switch	(DSL_STATUS_CODE(status->code)) {
		case kDslExceptionStatus:
			...
			BlockLongMove (32, (INT32 *) status->param.dslException.sp, (INT32*) dstPtr);
			dstPtr += 31;

			*dstPtr++ = (UINT32) status->param.dslException.argc;
			for (i = 0; i < status->param.dslException.argc; i++)
				*dstPtr++ = (UINT32) status->param.dslException.argv[i];
			}	
			break;
		...
		case kDslOLRBitGainUpdateStatus:
			...
			*dstPtr++ = status->param.dslOLRRequest.nCarrs;
			...
			dstPtr += 3;
			*dstPtr++ = (UINT32) status->param.dslOLRRequest.carrParamPtr;
			break;
		case kDslPwrMgrStatus:
			*dstPtr++ = status->param.dslPwrMsg.msgType;
			*dstPtr++ = status->param.dslPwrMsg.param.msg.msgLen;
			*dstPtr++ = (UINT32) status->param.dslPwrMsg.param.msg.msgData;
			break;
#endif
	}
...
Public int FlattenStatus (dslStatusStruct *status, UINT32 *dstPtr, UINT32 nAvail) ;
#else
Public int FlattenStatus (dslStatusStruct *status, UINT32 *dstPtr, UINT32 nAvail) FAST_TEXT;
#endif
Public int FlattenStatus (dslStatusStruct *status, UINT32 *dstPtr, UINT32 nAvail)
{
#define	CHECK_BUF_AVAIL(szReq,szAvail)	if ((INT32)(szReq) > (INT32)(szAvail)) return 0;

	UINT32	*dstPtr0 = dstPtr, statAvail = (nAvail >> 2);
	int		size;
	...
	*dstPtr++ = status->code;
	...
	switch	(DSL_STATUS_CODE(status->code)) {
		...
		case 		kDslDspControlStatus:
			...
			*dstPtr++ = (INT32)status->param.dslConnectInfo.buffPtr;
			break;
			...
			*dstPtr++ = status->param.dslConnectInfo.value;
			switch (status->param.dslConnectInfo.code) {
				...
				case kDslChannelQuietLineNoise:
					*dstPtr++ = (UINT32)status->param.dslConnectInfo.buffPtr;
					break;
			}
			break;
			...
			if (status->param.value >= kDslClearEocFirstCmd)
				...
				*dstPtr++ = status->param.dslClearEocMsg.msgType;
				if (status->param.dslClearEocMsg.msgType & kDslClearEocMsgDataVolatileMask)
					...
					*dstPtr++ = (UINT32) status->param.dslClearEocMsg.dataPtr;
				}
			break;
		...
		case kDslPrintfStatus:
			{
				...
				*dstPtr++ = (UINT32) status->param.dslPrintfMsg.fmt;
		...
		case kDslDataAvailStatus:
			*dstPtr++ = (UINT32) status->param.dslDataAvail.dataPtr;
		...
		case kDslAfeTestStatus:
			...
			*dstPtr++ = (UINT32) status->param.dslAfeTestStatus.type;
			*dstPtr++ = (UINT32) status->param.dslAfeTestStatus.param1;
			*dstPtr++ = (UINT32) status->param.dslAfeTestStatus.param2;			
			break;
...
#endif
#ifdef CONFIG_ARM64
UINT32	*pStackPtr = NULL;
#endif

Public int UnflattenStatus (UINT32 *srcPtr, dslStatusStruct *status)
{
	UINT32	*srcPtr0 = srcPtr;
	UINT32	tmp;
	...
	switch	(DSL_STATUS_CODE(status->code)) {
		...
		case		kDslShowtimeSNRMarginInfo:
			BlockLongMoveReverse (6, (INT32 *) srcPtr, (INT32 *) &status->param.dslShowtimeSNRMarginInfo);
			srcPtr += 6;
		...
		case		kAtmStatus:
			...
			switch (status->param.atmStatus.code) {
				...
				case kAtmStatCounters:
					...
					status->param.atmStatus.param.value = (INT32)(ADSL_ADDR_TO_HOST(status->param.atmStatus.param.value));
#endif
#endif
					break;
			}
...
#ifdef FLATTEN_ADDR_ADJUST
			{
				UINT32	fmtAddr = (UINT32)(uintptr_t)status->param.dslPrintfMsg.fmt;
#ifdef CHECK_LMEM_ADDR_IN_STAT
...
#endif
#if 0	/* Move address conversion to where the pointer is accessed to avoid address truncation on 64bits host processor */
			status->param.value = (INT32)(ADSL_ADDR_TO_HOST(status->param.value));
#endif
#endif
			break;
...
#endif
			status->param.dslDataAvail.dataPtr = (UINT32)(uintptr_t)(ADSL_ADDR_TO_HOST(status->param.dslDataAvail.dataPtr));
#endif
		...
		{
			UINT32 *pL = (void *) status->param.dslOLRRequest.L;	/* Endian converting "ushort  L[4]" */
		...
		case kDslStatusBufferChange:
			...
			status->param.value = (INT32)(ADSL_ADDR_TO_HOST(tmp));
			break;
#endif
		default:
			status->param.value = ADSL_ENDIAN_CONV_INT32(*srcPtr++);
...
Public int	FlattenBufferStatusWrite(stretchBufferStruct *fBuf, dslStatusStruct *status)
{
	UINT32	statBytesAvail, n, *p;
	char	*rdPtr;
	UINT32	critId = SoftDslEnterCritical();

#if defined(bcm47xx) && defined(ADSLCORE_ONLY)
	rdPtr = ((stretchBufferStruct *) ((UINT32)fBuf | 0x20000000))->pRead;
#else
	rdPtr = fBuf->pRead;
#endif
	...
	p = (UINT32 *) StretchBufferGetWritePtr(fBuf);
...
static UINT32	maxStatLen = 0;
static UINT32	maxStatBuf = 0;
#endif
...
#ifdef STATUS_BUFFER_STAT
	if ((UINT32)statBytesAvail > maxStatBuf) {
		maxStatBuf = (UINT32)statBytesAvail;
		__SoftDslPrintf(XdslCoreGetCurDslVars(), "FlattenBufferStatusStatT: maxLen=%ld, maxTotal=%ld", 0, maxStatLen, maxStatBuf);
	}
#endif

	p = (UINT32 *)StretchBufferGetReadPtr(fBuf);
#ifdef FLATTEN_ADDR_ADJUST
	p = (UINT32 *)(ADSL_ADDR_TO_HOST((uintptr_t)p));
#endif
#ifdef CONFIG_ARM64
	if(0 == ((uintptr_t)p >> 32)) {
		stretchBuf = *fBuf;
		...
		pmc_dsl_core_reset();
		bcmOsDelay(2);
		n = sprintf(buf, "FATAL: bogus/erroneous LMEM content\n");
...
#endif
	n = FlattenCommand (cmd, p, (UINT32)statBytesAvail-4);
	if (n > 0) {
		n = (n + 3) & ~3;
