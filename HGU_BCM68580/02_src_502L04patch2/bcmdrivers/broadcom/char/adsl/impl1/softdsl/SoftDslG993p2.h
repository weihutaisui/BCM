...
#define		PROFILEGFAST212A	0x2000
#define		PROFILEGFAST106B	0x4000
...
struct g993p2CommonDataPumpCapabilities
	...
	UINT32		profileSel;		/* bitMap bit 0 -7 profileselect for 8a,8b,8c,8d,12a,12b,17a,30a respectively */
	UINT32		maskUS0;
	UINT32		cfgFlags;

	UINT32		maskEU;		/* 0->32, 1->36, 2->40, 3->44, 4->48, 5->52, 6->56, 7->60, 8->64 */
	UINT32		maskADLU;		/* 0->32, 1->36, 2->40, 3->44, 4->48, 5->52, 6->56, 7->60, 8->64 */
	UINT32		annex;     /* 1->Annex A, 2->Annex B, 4->Annex C */
	};
...
typedef struct
	...
	UINT32		maskA_US0;		/* 0 -> A12b ; 1 -> A17a  ; */
	UINT32		maskB_US0;		/* 0 -> A12b ; 1 -> A17a  ; */
...
#define AFE_FE_REV_6304_REV_12_5_60_1	1       // AFE for ch0/ch1 with 6305.  GF_106; work with 63158
#define AFE_FE_REV_6304_REV_12_5_60_2	2       // AFE for ch0/ch1 with 6305.  GF_212; work with 63158
...
#define AFE_FE_REV_6304_REV_12_5_60_1_BITMAP	(AFE_FE_REV_6304_REV_12_5_60_1 << AFE_FE_REV_SHIFT)
#define AFE_FE_REV_6304_REV_12_5_60_2_BITMAP	(AFE_FE_REV_6304_REV_12_5_60_2 << AFE_FE_REV_SHIFT)
...
#define AFE_FE_COMB_A_12_3_60_0     (AFE_LD_6303_BITMAP | AFE_CHIP_CH0_BITMAP | AFE_FE_ANNEXA_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6303_REV_12_3_60_BITMAP)
#define AFE_FE_COMB_A_12_3_60_1     (AFE_LD_6303_BITMAP | AFE_CHIP_CH1_BITMAP | AFE_FE_ANNEXA_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6303_REV_12_3_60_BITMAP)
...
#define AFE_FE_COMB_X_12_5_60_1_0   (AFE_LD_6305_BITMAP | AFE_CHIP_GFCH0_BITMAP | AFE_FE_ANNEXX_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6304_REV_12_5_60_1_BITMAP)
#define AFE_FE_COMB_X_12_5_60_1_1   (AFE_LD_6305_BITMAP | AFE_CHIP_GFCH1_BITMAP | AFE_FE_ANNEXX_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6304_REV_12_5_60_1_BITMAP)
#define AFE_FE_COMB_X_12_5_60_2_0   (AFE_LD_6305_BITMAP | AFE_CHIP_GFCH0_BITMAP | AFE_FE_ANNEXX_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6304_REV_12_5_60_2_BITMAP)
#define AFE_FE_COMB_X_12_5_60_2_1   (AFE_LD_6305_BITMAP | AFE_CHIP_GFCH1_BITMAP | AFE_FE_ANNEXX_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6304_REV_12_5_60_2_BITMAP)
...
struct afeDescStruct
  ...
  UINT32   chipId;               /* Global chipID  such as 636800A0 */
  UINT32   boardAfeId;           /* Bitmaped field - copy of the NVRAM AFE ID */

  UINT32   afeChidIdConfig0;
  UINT32   afeChidIdConfig1;     /* bitmap to enable/control specific componion AFE chipset  behaviors */

  UINT32   afeTuningControl;                /* bitmap to control various compensation, 1 means enable, see AFE_TUNING_XX defs */
...
struct testConfigStruct {
  ...
  UINT32              rxType;       /* 0..3 meas 0 - none, 1 - avg, 2 - PLN, ...              */
                                      /* 4..5 0 = nonone, 1 = X^2+Y^2 ,2 = X+iY...              */
  UINT32              duration;     /* INFINIUM or  other non zero is duration in ms          */
  UINT32              avgPeriod;    /* average period in ms.                                  */
  UINT32              logAvgPeriod; /* floor(log2(avgPeriod)) - will be populated by adsl-mech*/
  UINT32              reportPeriod; /* report period in ms; 0 - default == avgPeriod          */
  ...
  UINT32              hwControl;    /* TX/RX frontend controls     */
  Psd993p2              psd;
...
struct ntrCntStruct {
    UINT32   ncoOutCntAtDmt;
    UINT32   ncoOutCntAtNtr;
    UINT32   lcoCntAtDmt;
    UINT32   lcoCntAtNtr;
    UINT32   ncoRefCntAtDmt;
    UINT32   ncoRefCntAtNtr;
    /* 6362/63268 */
...
struct ntrCfgStruct {
    UINT32   intModeDivRatio;     /* NTR output freq = 17.664e6/intModeDivRatio */
    UINT32   extModePhaseScale;   /* 6362 */
                                 /* ---- */
    ...
    UINT32   updatePeriod;        /* PLL update period in milliseconds  */
    INT32    b0;                  /* loop filter, b0       */
    INT32    b1;                  /* loop filter, b1       */
    uchar   operMode;
...
typedef struct {
    ...
    UINT32  pmeRemoteDiscoveryLow;
    UINT32  pmeAggregationReg;
    INT32   timeOfLastCL;
