...
extern	INT32			UtilBlockCosSin (int nValues, INT32 angle, INT32 delta, ComplexShort *dstPtr);
extern	INT32			UtilBlockCos (int nValues, INT32 angle, INT32 delta, short *dstPtr);
extern	ushort			UtilShortShortAtan2(ComplexShort point);
extern	ushort			UtilLongShortAtan2(ComplexLong point);
extern	UINT32			UtilShortLongAtan2(ComplexShort point) FAST_TEXT;
extern	UINT32			UtilLongLongAtan2(ComplexLong point) FAST_TEXT;
extern	ushort			UtilSqrt(UINT32 y);
extern	ushort			UtilMaxMagnitude(int blkSize, ComplexShort *dataPtr);
extern	short			UtilQ0LinearToQ4dB (UINT32 x);
extern	UINT32			UtilQ4dBToQ12Linear (short x);
extern	void			UtilAdjustComplexMagnitude(ComplexShort	*srcPtr, short mag, short adjustment);

extern	void VLMultLongByLong(INT32 x, INT32 y, VeryLong *dst);
extern	void VLMultShort	(VeryLong x, short y, VeryLong *dst);
extern	void VLAddVL		(VeryLong x, VeryLong y, VeryLong *dst);
extern	void VLAddLong	(VeryLong x, INT32 y, VeryLong *dst);
extern	void VLSubVL		(VeryLong x, VeryLong y, VeryLong *dst);
extern	void VLSubLong	(VeryLong x, INT32 y, VeryLong *dst);
extern	void VLDivVL		(VeryLong x, VeryLong y, int scale, INT32 *dst);
