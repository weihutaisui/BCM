...
typedef	int	(SM_DECL *adslMibNotifyHandlerType)	(void *gDslVars, UINT32 event);

extern Boolean	AdslMibInit(void *gDslVars, dslCommandHandlerType	commandHandler);
extern void		AdslMibTimer(void *gDslVars, UINT32 timeMs);
...
extern void		AdslMibBertStartEx(void *gDslVars, UINT32 bertSec);
extern void		AdslMibBertStopEx(void *gDslVars);
extern UINT32	AdslMibBertContinueEx(void *gDslVars, UINT32 totalBits, UINT32 errBits);
extern void		AdslMibSetLPR(void *gDslVars);
extern void		AdslMibSetShowtimeMargin(void *gDslVars, INT32 showtimeMargin);
...
extern void AdslMibUpdateACTPSD(void *gDslVars, INT32 ACTATP, unsigned char dir);
