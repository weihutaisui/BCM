...
typedef struct
    ...
    UINT32      impdet_error_norm[kG992EqualizerImpDetMaxToneSetSize];
    UINT32      impdet_impulse_norm;
...
typedef struct _dslFrameBuffer
	...
	UINT32				length;	/* size (in bytes) of data */
	} dslFrameBuffer;
...
typedef struct _dslFrame
	...
	UINT32			totalLength;	/* total amount of data in the packet */
...
typedef struct
	{
	UINT32 (SM_DECL *__DslFrameBufferGetLength) (dslFrameBuffer *fb);
	void * (SM_DECL *__DslFrameBufferGetAddress) (dslFrameBuffer *fb);
	void (SM_DECL *__DslFrameBufferSetLength) (dslFrameBuffer *fb, UINT32 l);
	void (SM_DECL *__DslFrameBufferSetAddress) (dslFrameBuffer *fb, void *p);

	void (SM_DECL *__DslFrameInit) (dslFrame *f);
	UINT32 (SM_DECL *__DslFrameGetLength) (dslFrame *pFrame);
	UINT32 (SM_DECL *__DslFrameGetBufCnt) (dslFrame *pFrame);
	...
	void * (SM_DECL *__DslFrameAllocMemForFrames) (UINT32 frameNum);
	...
	void * (SM_DECL *__DslFrameAllocMemForBuffers) (void **ppMemPool, UINT32 bufNum, UINT32 memSize);
	void (SM_DECL *__DslFrameFreeMemForBuffers) (void *hMem, UINT32 memSize, void *pMemPool);
	dslFrameBuffer * (SM_DECL *__DslFrameAllocBuffer) (void *handle, void *pMem, UINT32 length);
	void (SM_DECL *__DslFrameFreeBuffer) (void *handle, dslFrameBuffer *pBuf);

	/* for LOG file support */

	UINT32 (SM_DECL *__DslFrame2Id)(void *handle, dslFrame *pFrame);
	void * (SM_DECL *__DslFrameId2Frame)(void *handle, UINT32 frameId);
	} dslFrameFunctions;

#define	 DslFrameDeclareFunctions( name_prefix )								\
extern UINT32 SM_DECL name_prefix##BufferGetLength(dslFrameBuffer *fb);			\
extern void * SM_DECL name_prefix##BufferGetAddress(dslFrameBuffer *fb);		\
extern void SM_DECL name_prefix##BufferSetLength(dslFrameBuffer *fb, UINT32 l);	\
extern void SM_DECL name_prefix##BufferSetAddress(dslFrameBuffer *fb, void *p); \
																				\
extern void SM_DECL name_prefix##Init(dslFrame *f);								\
extern UINT32 SM_DECL name_prefix##GetLength (dslFrame *pFrame);					\
extern UINT32 SM_DECL name_prefix##GetBufCnt(dslFrame *pFrame);					\
...
extern dslFrameBuffer * SM_DECL name_prefix##DequeBuffer(dslFrame *pFrame);				\
																						\
extern void * SM_DECL name_prefix##AllocMemForFrames(UINT32 frameNum);					\
...
extern void * SM_DECL name_prefix##AllocMemForBuffers(void **ppMemPool, UINT32 bufNum, UINT32 memSize);	\
extern void SM_DECL name_prefix##FreeMemForBuffers(void *hMem, UINT32 memSize, void *pMemPool);			\
extern dslFrameBuffer * SM_DECL name_prefix##AllocBuffer(void *handle, void *pMem, UINT32 length);		\
extern void SM_DECL name_prefix##FreeBuffer(void *handle, dslFrameBuffer *pBuf);		\
extern UINT32 SM_DECL name_prefix##2Id(void *handle, dslFrame *pFrame);					\
extern void * SM_DECL name_prefix##Id2Frame(void *handle, UINT32 frameId);
...
struct _dslFramerBufDesc;
	...
	typedef	void*   (SM_DECL *dslHeaderHandlerType) (void *gDslVars, UINT32 hdr, uchar hdrHec);
	...
	typedef	UINT32	(SM_DECL *dslLinkVc2IdHandlerType) (void *gDslVars, void *);
	typedef	void*	(SM_DECL *dslLinkVcId2VcHandlerType) (void *gDslVars, UINT32);
	...
	typedef	void	(SM_DECL *dslLinkStatusHandler) (void *gDslVars, UINT32 statusCode, ...);
	...
	typedef	void*   (SM_DECL *dslHeaderHandlerType) (UINT32 hdr, uchar hdrHec);
	...
	typedef	UINT32	(SM_DECL *dslLinkVc2IdHandlerType) (void *);
	typedef	void*	(SM_DECL *dslLinkVcId2VcHandlerType) (UINT32);
	...
	typedef	void	(SM_DECL *dslLinkStatusHandler) (UINT32 statusCode, ...);
...
typedef INT32	dslErrorCode;

typedef INT32	atmStatusCode;
typedef INT32	dslFramerStatusCode;

typedef INT32	atmErrorCode;

typedef INT32	dslTrainingStatusCode;
...
typedef	INT32	dslConnectInfoStatusCode;
...
typedef struct _dslShowtimeSNRMarginInfoType
	{
		INT32						maxMarginCarrier;
		INT32						maxSNRMargin;
		INT32						minMarginCarrier;
		INT32						minSNRMargin;
		INT32						avgSNRMargin;
		INT32						nCarriers;
		void						*buffPtr;
...
typedef	struct
	...
	union
		...
		struct
			...
			union
				...
				struct
					...
					INT32	vci;
					INT32	aalType;
					UINT32   fwdPeakCellTime;
					UINT32   backPeakCellTime;
					} vcInfo;
				struct
					{
					INT32	cellHdr;
		...
		struct
			...
			UINT32	nAudioBits;
			UINT32	nAudioBlocks;
			UINT32	nAudioSyncErrors;
			UINT32	nAudioBlockErrors;
			} testResults;
		struct
			{
			UINT32	code;
		...
		struct
			...
			UINT32	txSignalChecksum;
			UINT32	rxSignalChecksum;
			UINT32	eyeDataChecksum;
			} checksums;
		struct
			{
			int		sp;
...
typedef struct
        ...
        UINT32                           packetsRxCrcErr;
        } GfastEocCounters;

typedef struct
        {
        UINT32                           cntVecFBSegmentSend;
        UINT32                           cntVecFBSegmentDrop;
        UINT32                           cntVecFBMessageSend;
        UINT32                           cntVecFBMessageDrop;
	...
	union
		...
		struct
			...
			union
				...
				struct
					{
					UINT32				xmtStartTone, xmtNumOfTones;
					UINT32				rcvStartTone, rcvNumOfTones;
					uchar				*xmtMap, *rcvMap;
					} toneSelectSpec;
				struct
					{
					INT32				extraPowerRequestQ4dB;
					INT32				numOfCarriers;
		...
		struct
			{
			bitMap						setup;
			UINT32						eyeConstIndex1;
			UINT32						eyeConstIndex2;
			UINT32						logTime;
			} dslDiagSpec;
		struct
			{
		...
		struct
			{
			UINT32						plnCmd;
			UINT32						mgnDescreaseLevelPerBin;
			UINT32						mgnDescreaseLevelBand;
			UINT32						nInpBin;
			ushort						*inpBinPtr;
			UINT32						nItaBin;
			ushort						*itaBinPtr;
...
typedef	struct __dslDiagCommandStruct
	...
	union
		...
		struct
			...
			union
				...
				struct
					...
					UINT32				xmtStartTone, xmtNumOfTones;
					UINT32				rcvStartTone, rcvNumOfTones;
					UINT32				xmtMap, rcvMap;
					} toneSelectSpec;
				struct
					{
					INT32				extraPowerRequestQ4dB;
					INT32				numOfCarriers;
					UINT32				marginTweakTableQ4dB;
					} marginTweakSpec;
				UINT32					value;
				} param;
			} dslTestSpec;
		...
		struct
			...
			UINT32						mgnDescreaseLevelBand;
			UINT32						nInpBin;
			UINT32						inpBinPtr;	/* ushort pointer */
			UINT32						nItaBin;
			UINT32						itaBinPtr;	/* ushort pointer */
			ushort					inmContinueConfig;
			ushort					inmInpEqMode;
			ushort					inmIATO;
			ushort					inmIATS;
...
typedef struct
  ...
  INT32 dslG994p1RevisionSwitchCounter;
    INT32 dslG994p1NAKCounter;
  ...
  uchar g994p1FalseCToneCarrCount[12];
...
#ifdef	T1P413
	INT32		nextStartupMode;
	UINT32		currentModeCounter;
#endif
	...
	UINT32		t1p413HighLowPowerCounter;
...
#endif
    UINT32   interopRetrainFlags;              /* Number of retrain flags are growing. Use bit map in interopRetrainFlags register */
...
extern void		SM_DECL SoftDslSetRefData	(void *gDslVars, UINT32 refData);
extern UINT32	        SM_DECL SoftDslGetRefData	(void *gDslVars);
...
extern UINT32	SoftDslGetSymCntTotal(void *gDslVars);
extern UINT32	SoftDslGetSymCntPhase(void *gDslVars);

/* SoftDsl time functions	*/

extern UINT32	        SM_DECL SoftDslGetTime(void *gDslVars);
#define			__SoftDslGetTime(gv)		gDslGlobalVarPtr->execTime

extern void		SM_DECL SoftDslTimer(void *gDslVars, UINT32 timeMs);

/* SoftDsl IO functions	*/

extern void		SM_DECL SoftDslClose (void *gDslVars);
extern int		SM_DECL SoftDslSendFrame (void *gDslVars, void *pVc, UINT32 mid, dslFrame * pFrame);
extern int		SM_DECL SoftDslReturnFrame (void *gDslVars, void *pVc, UINT32 mid, dslFrame * pFrame);
...
extern  Boolean SM_DECL SoftDslVcConfigure(void *gDslVars, void *pVc, UINT32 mid, dslVcParams *pVcParams);

/* Special functions for LOG support */

extern  UINT32	SM_DECL SoftDslVc2Id(void *gDslVars, void *pVc);
extern  void*	SM_DECL SoftDslVcId2Vc(void *gDslVars, UINT32 vcId);
extern	void*	SM_DECL SoftDslGetFramePool(void *gDslVars);

/* Functions for host mode execution */

extern  void*   SM_DECL SoftDslRxCellHeaderHandler (void *gDslVars, UINT32 hdr, uchar hdrHec);
...
extern  void*	SM_DECL SoftDslGetG994p1RcvNonStdInfo(void *gDslVars, UINT32 *pLen);
extern  void*	SM_DECL SoftDslGetG994p1XmtNonStdInfo(void *gDslVars, UINT32 *pLen);

#ifdef G997_1_FRAMER

/* G997 functions */

extern int		SM_DECL SoftDslG997SendFrame (void *gDslVars, void *pVc, UINT32 mid, dslFrame * pFrame);
extern int		SM_DECL SoftDslG997ReturnFrame (void *gDslVars, void *pVc, UINT32 mid, dslFrame * pFrame);
...
extern void *  SoftDslBgMonUpdate(void *gDslVars, UINT32 cycCnt);
extern void	   SoftDslBgMonReset(void *gDslVars);
extern void	   SoftDslBgMonSetBgTcb(void *gDslVars, void *pTcb);

#if	(defined(BCM6368_SRC) && (!defined(VDSL_ONLY)))
extern UINT32		SoftDslGetModulationCapability(void *gDslVars);
#ifdef	T1P413
extern void		SoftDslSelectStartupMode(void *gDslVars, int timeInterval, INT32 currentStartupMode);
...
#define SoftDslGetTlsData(idx)				((UINT32 *)SoftDslGetTls())[idx]
#define SoftDslSetTlsData(idx,data)			((UINT32 *)SoftDslGetTls())[idx] = (data)
...
extern void SoftDslMipsSleep(UINT32 usec, int shift);
...
#define	DSL_MIPSCORE_ID(x)		((uchar)(((UINT32)(x) & DSL_MIPSCORE_MASK) >> DSL_MIPSCORE_SHIFT))
...
#define	DSL_LINE_ID(x)		((uchar)(((UINT32)(x) & DSL_LINE_MASK) >> DSL_LINE_SHIFT))
#else
