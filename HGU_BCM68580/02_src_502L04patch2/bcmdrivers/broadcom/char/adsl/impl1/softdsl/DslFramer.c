...
Private void DslFramerReportFrame(void *gDslVars, dslFramerControl *dfCtrl, UINT32 frameStatusCode, dslFrame *pFrame)
{
...
Private void DslFramerReportStatus(void *gDslVars, dslFramerControl *dfCtrl, UINT32 statusCode, int value)
{
	dslStatusStruct		status;
	dslFramerStatus		*pFramerStatus;
