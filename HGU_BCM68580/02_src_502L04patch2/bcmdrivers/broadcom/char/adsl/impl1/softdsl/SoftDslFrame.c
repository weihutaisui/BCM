...
Public UINT32 DslFrameNativeBufferGetLength(dslFrameBuffer *fb)
{
	return fb->length;
}
...
Public void DslFrameNativeBufferSetLength(dslFrameBuffer *fb, UINT32 l)
{
	fb->length = l;
}
...
Public UINT32 DslFrameNativeGetLength (dslFrame *pFrame)
{
	return pFrame->totalLength;
}

Public UINT32 DslFrameNativeGetBufCnt(dslFrame *pFrame)
{
...
Public void * DslFrameNativeAllocMemForFrames(UINT32 frameNum)
{
	return NULL;
}
...
Public void * DslFrameNativeAllocMemForBuffers(void **ppMemPool, UINT32 bufNum, UINT32 memSize)
{
	return NULL;
}

Public void DslFrameNativeFreeMemForBuffers(void *hMem, UINT32 memSize, void *pMemPool)
{
}

Public dslFrameBuffer * DslFrameNativeAllocBuffer(void *handle, void *pMem, UINT32 length)
{
	return NULL;
}
...
Public UINT32 DslFrameNative2Id (void *handle, dslFrame *pFrame)
{
	return 0;
}

Public void * DslFrameNativeId2Frame (void *handle, UINT32 frameId)
{
	return NULL;
}
