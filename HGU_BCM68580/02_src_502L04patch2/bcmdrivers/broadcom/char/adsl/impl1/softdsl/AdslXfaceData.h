...
typedef struct _DslParamData {
	...
	UINT8       verId;  /* version ID */
	UINT8       ctrl;   /* reserved */
	UINT32      lowSdramSize;    /* required size of low (below 16MB SDRAM) */
} DslParamData;
...
typedef struct _AdslOemSharedData {
	UINT32	g994VendorIdLen;
	UINT32	g994XmtNonStdInfoLen;
	UINT32	g994RcvNonStdInfoLen;
	UINT32	eocVendorIdLen;
	UINT32	eocVersionLen;
	UINT32	eocSerNumLen;
	UINT8		g994VendorId[kAdslOemVendorIdMaxSize];
	UINT8		eocVendorId[kAdslOemVendorIdMaxSize];
	UINT8		eocVersion[kAdslOemVersionMaxSize];
	UINT8		eocSerNum[kAdslOemSerNumMaxSize];
	UINT8		g994XmtNonStdInfo[kAdslOemNonStdInfoMaxSize];
	UINT8		g994RcvNonStdInfo[kAdslOemNonStdInfoMaxSize];
	UINT32	gDslVerionStringPtr;
	UINT32	gDslBuildDataStringPtr;
	UINT32	t1413VendorIdLen;
	UINT8		t1413VendorId[kAdslOemVendorIdMaxSize];
	UINT32	t1413EocVendorIdLen;
	UINT8		t1413EocVendorId[kAdslOemVendorIdMaxSize];
	UINT32	clEocBufLen;
	UINT32	clEocBufPtr;
} AdslOemSharedData;
