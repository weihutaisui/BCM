...
typedef struct {
	...
	UINT32			diagDmaLogBlockNum;
	UINT32			diagDataMap[MAX_DSL_LINE];
	UINT32			diagLogTime[MAX_DSL_LINE];
...
int __DiagWriteData(struct sk_buff *diagBuf, UINT32 cmd, char *buf0, int len0, char *buf1, int len1);
