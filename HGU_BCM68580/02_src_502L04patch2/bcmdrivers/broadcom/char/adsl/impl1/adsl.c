...
BCMADSL_STATUS BcmAdsl_Initialize(ADSL_FN_NOTIFY_CB pFnNotifyCb, void *pParm, adslCfgProfile *pAdslCfg)
{
    ...
    //BcmAdslCoreSetSDRAMBaseAddr((void *) (((UINT32) kerSysGetSdramSize() - 0x40000) | 0xA0000000));
...
#else
	BcmAdslCoreSetSDRAMBaseAddr((void *) ((UINT32) kerSysGetSdramSize() - 0x40000));
#endif
...
BCMADSL_STATUS BcmAdsl_Initialize(ADSL_FN_NOTIFY_CB pFnNotifyCb, void *pParm, adslCfgProfile *pAdslCfg)
{
    ...
    BcmAdslCoreSetSDRAMBaseAddr((void *)
        ((UINT32) kerSysGetSdramSize() | 0xA0000000));
    BcmAdslCoreConfigure(pAdslCfg);
...
static void BcmXdslProcessDrvConfigReq(unsigned lineId, volatile drvRegControl *pDrvRegCtrl)
{
