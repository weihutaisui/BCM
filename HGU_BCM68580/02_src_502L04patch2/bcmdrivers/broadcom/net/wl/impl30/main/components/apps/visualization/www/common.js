...
function initCommonPage()
{
	if (isHTTPDWebserver == 1) {
		...
		urlconfigsettings = window.location.protocol + '//localhost/counterdata.php';
		gURLBands =  window.location.protocol + '//localhost/getallbands.php';
		g_UrlCommonGetNVRAM = window.location.protocol + '//localhost/getnvram.php';
	}
}
