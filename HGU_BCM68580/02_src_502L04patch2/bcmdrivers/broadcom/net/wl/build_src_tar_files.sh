...
exclude=" \
  ...
  --exclude=$imp/router/bsd/*.h \
  --exclude=$imp/router/bsd/*.c \
  --exclude=$imp/router/bshared/include \
  --exclude=$imp/router/bshared/src \
  --exclude=$imp/router/lltd/src/*.h \
  --exclude=$imp/router/lltd/src/*.c \
  --exclude=$imp/router/lltd/src/README.TXT \
  --exclude=$imp/router/lltd/src/S75lld2 \
  --exclude=$imp/router/lltd/src/wrt54g.small.ico \
  --exclude=$imp/router/lltd/src/wrt54g.large.ico \
  --exclude=$imp/router/lltd/src/lld2d.conf \
  --exclude=$imp/router/lltd/src/Makefile \
  --exclude=$imp/router/lltd/src/common.mk \
