...
sub output_merged_data_model
{
    ...
    print $fileoutRef "<xmlMandatorySingleRootNode copyright=\"Broadcom Corporation, 2006-2012\" ";
...
elsif ($ARGV[0] eq "report")
{
    ...
    $inputFileRef = open_filehandle_for_input("$build_dir/data-model/$inputFile");
    $outputFileRef = open_filehandle_for_output("$build_dir/docs/customerDocs/CMS-supported-parameters-report.txt");
    ...
    $spreadsheet1Done = 0;
    $inputFileRef = open_filehandle_for_input("$build_dir/data-model/$inputFile");
    $outputFileRef = open_filehandle_for_output("$build_dir/docs/customerDocs/CMS-supported-profiles-report.txt");
...
elsif ($ARGV[0] eq "report2")
{
    ...
    $inputFileRef = open_filehandle_for_input("$build_dir/data-model/$inputFile");
    $outputFileRef = open_filehandle_for_output("$build_dir/docs/customerDocs/CMS-supported-parameters-report2.txt");
    ...
    $spreadsheet1Done = 0;
    $inputFileRef = open_filehandle_for_input("$build_dir/data-model/$inputFile");
    $outputFileRef = open_filehandle_for_output("$build_dir/docs/customerDocs/CMS-supported-profiles-report2.txt");
